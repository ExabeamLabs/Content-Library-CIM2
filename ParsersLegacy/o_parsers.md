...
| oracle-dummy-parser                    | oracle-pc-json-app-authentication-fail-sessioncreatefailure        |
| oracle-dummy-parser-1                  | oracle-pc-json-app-activity-success-adminaccountcreatesuccess      |
| oracle-dummy-parser-10                 | oracle-pc-json-user-disable-success-userdeactivated                |
| oracle-dummy-parser-11                 | oracle-pc-json-user-modify-success-userupdatesuccess               |
| oracle-dummy-parser-12                 | oracle-pc-json-app-notification-success-jobsucceeded               |
| oracle-dummy-parser-13                 | oracle-pc-json-app-notification-success-notificationsuccess        |
| oracle-dummy-parser-14                 | oracle-pc-json-app-authentication-success-responsesent             |
| oracle-dummy-parser-15                 | oracle-pc-json-app-authentication-fail-responsereceivefail         |
| oracle-dummy-parser-16                 | oracle-pc-json-app-authentication-success-responsereceivesuccess   |
| oracle-dummy-parser-17                 | oracle-pc-json-user-create-success-accountcreatesuccess            |
| oracle-dummy-parser-18                 | oracle-pc-json-app-activity-success-appupdatesuccess               |
| oracle-dummy-parser-2                  | oracle-pc-json-app-activity-success-objectupdateuccess             |
| oracle-dummy-parser-3                  | oracle-pc-json-app-activity-success-accountupdatesuccess           |
| oracle-dummy-parser-4                  | oracle-pc-json-app-activity-success-deviceupdatesuccess            |
| oracle-dummy-parser-5                  | oracle-pc-json-app-activity-success-grantcreatesuccess             |
| oracle-dummy-parser-6                  | oracle-pc-json-group-member-add-success-memberaddsuccess           |
| oracle-dummy-parser-7                  | oracle-pc-json-group-member-remove-success-memberremovesuccess     |
| oracle-dummy-parser-8                  | oracle-pc-json-group-modify-success-groupupdatesuccess             |
| oracle-dummy-parser-9                  | oracle-pc-json-user-create-success-usercreatesuccess               |
