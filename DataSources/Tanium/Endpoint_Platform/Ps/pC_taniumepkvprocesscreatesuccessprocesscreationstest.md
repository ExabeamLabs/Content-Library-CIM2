...
```Java
{
Name = tanium-ep-kv-process-create-success-processcreationstest
    Vendor = Tanium
    ...
    Fields = [
      ...
      """\sParent-Process-Path="(-|<Unknown Process>|({parent_process}({parent_process_dir}[^"]*?[\\\/]+)?({parent_process_name}[^"\\\/]+)))"""",
