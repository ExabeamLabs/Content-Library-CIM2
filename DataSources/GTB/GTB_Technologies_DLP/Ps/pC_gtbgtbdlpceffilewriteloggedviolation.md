...
```Java
{
Name = gtb-gtbdlp-cef-file-write-loggedviolation
  ParserVersion = "v1.0.0"
  Conditions = [ """CEF:""", """|GTB|""", """|I/O Logged|I/O Logged Violation|""", """operation=Copy from NetworkShare to CD/DVD act=Logged""" ]
