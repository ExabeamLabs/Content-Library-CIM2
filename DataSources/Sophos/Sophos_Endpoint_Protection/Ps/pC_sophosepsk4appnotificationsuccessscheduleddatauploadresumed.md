...
```Java
{
Name = sophos-ep-sk4-app-notification-success-scheduleddatauploadresumed
  Conditions = [ """CEF:""", """destinationServiceName =Sophos Central""", """"type":"Event::Endpoint::ScheduledDataUploadResumed"""", """"group":"GENERAL"""", """"severity":"""" ]
