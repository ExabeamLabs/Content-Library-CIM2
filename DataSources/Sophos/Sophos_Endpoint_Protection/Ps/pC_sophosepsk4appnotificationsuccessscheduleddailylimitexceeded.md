...
```Java
{
Name = sophos-ep-sk4-app-notification-success-scheduleddailylimitexceeded
  Conditions = [ """CEF:""", """destinationServiceName =Sophos Central""", """"type":"Event::Endpoint::ScheduledDailyLimitExceeded"""", """"group":"GENERAL"""", """"severity":"""" ]
