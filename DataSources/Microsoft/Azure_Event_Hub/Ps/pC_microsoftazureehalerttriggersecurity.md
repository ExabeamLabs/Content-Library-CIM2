...
```Java
{
Name = microsoft-azureeh-alert-trigger-security
  ...
  Fields = ${LMSMSParsersTemplates.cef-microsoft-app-activity.Fields}[
    ...
    """"properties".*?"eventProperties".*?"clientIPAddress":"({src_ip}[a-fA-F\d.:]+)"""",
    """\Wext_properties_eventProperties_attackers_0_=({src_ip}[a-fA-F\d.:]+)""",
    """"properties".*?"eventProperties".*?"attackers":\["({src_ip}[a-fA-F\d.:]+)"""",
