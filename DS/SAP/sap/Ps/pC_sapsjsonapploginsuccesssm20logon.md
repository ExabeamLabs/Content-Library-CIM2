...
```Java
{
Name = sap-s-json-app-login-success-sm20logon
  Product = SAP
  Conditions = [ """"CURRENT_TIMESTAMP":""", """"UTCDIFF":""", """"EVENT_TYPE":""", """"SM20"""", """Logon successful""", """"EVENT_SUBTYPE":""" ]
...
sap-events-2 = {
    ...
    Fields = [
      ...
      """exa_json_path=$.ALGLTERM,exa_regex=({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?""",
