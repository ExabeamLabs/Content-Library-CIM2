...
```Java
{
Name = microsoft-m365auditlogs-kv-file-property-modify-sharinginheritancebroken
  ParserVersion = v1.0.0
  Conditions = [ """SESSID=""", """RESULTCODE=""", """WORKLOAD=""", """COMMAND=SharingInheritanceBroken""", """OBJECT=""" ]
  Fields = ${DLMicrosoftParsersTemplates.logrhythm-o365-app-activity.Fields}[
    """OBJECT=(Unknown \(Unknown\)|({file_path}[^=]+?))\s+\w+="""
  ]
