...
```Java
{
Name = airlock-allowlisting-json-alert-trigger-success-pprocess
  Vendor = Airlock
  Product = Airlock Allowlisting
  TimeFormat = "yyyy-MM-dd'T'HH:mm:ssZ"
  ExtractionType = json
  Conditions = [ """"pprocess":""", """"gprocess":""", """"ppolicy":""", """"type":""" ]
  Fields = [
