...
Conditions = [ """"type":"""", """destinationServiceName =Netskope""", """"activity":"Login Attempt"""" ]
DupFields = ${NetskopeParsersTemplates.cef-netskope-activity-1.DupFields}[ "host->dest_host", "operation->access", "object->file_name" ]
