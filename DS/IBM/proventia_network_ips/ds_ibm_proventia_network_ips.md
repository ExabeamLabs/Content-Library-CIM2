...
|:----:| ---- | ---- | ---- |
| [Compromised Credentials](../../../UseCases/uc_compromised_credentials.md) |  network-alert<br> ↳[ibm-pnips-leef-alert-trigger-success-attack](Ps/pC_ibmpnipsleefalerttriggersuccessattack.md)<br> | T1027.005 - Obfuscated Files or Information: Indicator Removal from Tools<br>T1190 - Exploit Public Fasing Application<br> | [<ul><li>24 Rules</li></ul><ul><li>9 Models</li></ul>](RM/r_m_ibm_proventia_network_ips_Compromised_Credentials.md) |
