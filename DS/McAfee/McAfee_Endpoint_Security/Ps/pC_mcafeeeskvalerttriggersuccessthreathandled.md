...
```Java
{
Name = mcafee-es-kv-alert-trigger-success-threathandled
  ...
  SOAR {
    ...
    DupFields = ["time->startedDate", "vendor->source", "rawLog->sourceInfo", "alert_id->sourceId", "alert_name->malwareName", "alert_type->malwareCategory", "alert_severity->sourceSeverity", "url->malwareAttackerFile"]
