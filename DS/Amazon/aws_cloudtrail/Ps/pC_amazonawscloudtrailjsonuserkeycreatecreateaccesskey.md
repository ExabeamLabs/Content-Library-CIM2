...
```Java
{
Name = amazon-awscloudtrail-json-user-key-create-createaccesskey
  Vendor = Amazon
  ...
  """"+responseElements.+?userName\\?":\s*\\?"({identities}[^"]+?)\\?"""",
  """"+responseElements.+?accessKeyId\\?":\s*\\?"({key_id}[^"]+?)\\?"""",
  """"+responseElements.+?status\\?":\s*\\?"({key_status}[^"]+?)\\?"""",
  """exa_json_path=$.responseElements.accessKey.userName,exa_field_name=identities""",
  """exa_json_path=$.responseElements.accessKey.accessKeyId,exa_field_name=key_id""",
  """exa_json_path=$.responseElements.accessKey.status,exa_field_name=key_status"""
]
