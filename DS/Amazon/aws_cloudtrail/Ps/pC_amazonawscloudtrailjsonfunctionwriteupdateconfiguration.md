...
Name = amazon-awscloudtrail-json-function-write-updateconfiguration
  ...
  """"+requestParameters.+?functionName\\?":\s*\\?"({function_name}[^"]+?)\\?"""",
  """"+responseElements.+?functionArn\\?":\s*\\?"({function_arn}[^"]+?)\\?"""",
  """"+responseElements.+?runtime\\?":\s*\\?"({function_runtime}[^"]+?)\\?"""",
  """"+responseElements.+?role\\?":\s*\\?"({function_role}[^"]+?)\\?"""",
  """"+responseElements.+?codeSize\\?":\s*\\?({code_size}\d+)\\?""",
