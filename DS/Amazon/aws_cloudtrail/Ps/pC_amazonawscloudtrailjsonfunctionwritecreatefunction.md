...
```Java
{
Name = amazon-awscloudtrail-json-function-write-createfunction
  Vendor = Amazon
  ...
  """exa_json_path=$.requestParameters.functionName,exa_field_name=function""",
  """exa_json_path=$.requestParameters.runtime,exa_field_name=function_runtime""",
  """exa_json_path=$.requestParameters.role,exa_field_name=function_role""",
  """exa_json_path=$.responseElements.functionArn,exa_field_name=function_arn""",
  """exa_json_path=$.responseElements.codeSize,exa_field_name=code_size""",
  """exa_json_path=$.responseElements.codeSha256,exa_field_name=code_sha256"""
   ]
}, 
...
${AwsParserTemplates.aws-cloudtrail-json}{
  ...
  Fields = ${AwsParserTemplates.aws-cloudtrail-json.Fields}[
  """exa_json_path=$.requestParameters.targets[*].values[0],exa_field_name=resource_id"""
  """exa_json_path=$.requestParameters.documentName,exa_field_name=document_name"""
  """exa_json_path=$.requestParameters..PlaybookFile[0],exa_field_name=playbook_files"""
    ]
