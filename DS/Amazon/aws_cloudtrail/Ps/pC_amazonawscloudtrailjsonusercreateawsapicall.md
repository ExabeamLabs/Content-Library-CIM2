...
```Java
{
Name = amazon-awscloudtrail-json-user-create-awsapicall
  Vendor = Amazon
  ...
  Fields = ${AwsParserTemplates.aws-cloudtrail-json.Fields}[
    """exa_json_path=$.responseElements..userName,exa_field_name=identities""",
    """exa_json_path=$.responseElements..userId,exa_field_name=role_id""",
    """exa_json_path=$.responseElements..arn,exa_field_name=role_arn"""
  ]
