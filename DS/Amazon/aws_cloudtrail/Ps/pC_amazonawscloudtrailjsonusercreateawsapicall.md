...
Name = amazon-awscloudtrail-json-user-create-awsapicall
  ...
  Fields = ${AwsParserTemplates.aws-cloudtrail-json.Fields}[
    """exa_json_path=$.responseElements..userName,exa_field_name=identity""",
    """exa_json_path=$.responseElements..userId,exa_field_name=identity_id""",
    """exa_json_path=$.responseElements..arn,exa_field_name=identity_arn"""
  ]
