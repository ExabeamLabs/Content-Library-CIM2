...
```Java
{
Name = amazon-awscloudtrail-json-bucket-accessblock-modify-awsapicall
  Vendor = Amazon
  ...
  """exa_json_path=$.requestParameters..RestrictPublicBuckets,exa_field_name=restrict_public_buckets""",
  """exa_json_path=$.requestParameters..BlockPublicPolicy,exa_field_name=block_public_policy""",
  """exa_json_path=$.requestParameters..BlockPublicAcls,exa_field_name=block_public_acls""",
  """exa_json_path=$.requestParameters..IgnorePublicAcls,exa_field_name=ignore_public_acls""",
