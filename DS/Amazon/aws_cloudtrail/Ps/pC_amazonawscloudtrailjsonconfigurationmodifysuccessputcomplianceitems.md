...
```Java
{
Name = amazon-awscloudtrail-json-configuration-modify-success-putcomplianceitems
  Conditions = [ """AwsApiCall""", """"eventName":""", """"PutComplianceItems"""" ]
  Fields = ${AwsParserTemplates.aws-cloudtrail-json.Fields}[
    """"+requestParameters":\{("[^,]+,)*"resourceId\\?":\s*\\?"({object}[^"]+?)\\?"""",
  ]
