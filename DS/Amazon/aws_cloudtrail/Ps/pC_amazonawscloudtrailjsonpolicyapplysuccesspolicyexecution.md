...
Name = amazon-awscloudtrail-json-policy-apply-success-policyexecution
  ...
  Fields = ${DLAwsParserTemplates.aws-cloudtrail-json-1.Fields}[
      ...
      """exa_json_path=$..lifecycleEventRules[0]..countNumber,exa_field_name=rule_count"""
      """exa_json_path=$..countType,exa_field_name=rule_type"""
      """exa_json_path=$..lifecycleEventRules[0]..rulePriority,exa_field_name=rule_severity"""
      """exa_json_path=$..repositoryName,exa_field_name=repository_name"""
      """exa_json_path=$.resources[*].type,exa_field_name=resource_type"""
      """exa_json_path=$.resources[*].ARN,exa_field_name=policy_arn"""
      """exa_json_path=$.resources[*].accountId,exa_field_name=resource_id"""
  ]
