...
```Java
{
Name = amazon-awscloudtrail-json-key-write-createkeypair
  Vendor = Amazon
  ...
  """exa_json_path=$.requestParameters.keyType,exa_field_name=key_type""",
  """exa_json_path=$.responseElements.keyPairId,exa_field_name=resource_id""",
  ]
