...
Name = amazon-awscloudtrail-json-role-create-success-createrole
  ...
  """exa_json_path=$.responseElements.role.roleName,exa_field_name=identity""",
  """exa_json_path=$.responseElements.role.roleId,exa_field_name=identity_id""",
  """exa_json_path=$.responseElements.role.arn,exa_field_name=identity_arn""",
  """exa_json_path=$.requestParameters.roleName,exa_field_name=role_name""",
  ]
  DupFields = ["identity->role_name", "identity_id->role_id","result->failure_code"]
