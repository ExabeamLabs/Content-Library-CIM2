...
```Java
{
Name = amazon-awscloudtrail-json-bucket-permission-modify-putbucketcors
  Vendor = Amazon
  ...
  """exa_json_path=$.requestParameters..AllowedMethod[*],exa_field_name=allowed_permissions""",
  """exa_json_path=$.requestParameters..AllowedOrigin,exa_field_name=allowed_origins""",
  """exa_json_path=$.requestParameters..AllowedHeader,exa_field_name=allowed_headers""",
  ]
