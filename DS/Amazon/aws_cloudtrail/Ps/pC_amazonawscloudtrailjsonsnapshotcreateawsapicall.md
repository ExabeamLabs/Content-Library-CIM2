...
```Java
{
Name = amazon-awscloudtrail-json-snapshot-create-awsapicall
  Vendor = Amazon
  ...
  """exa_json_path=$.requestParameters,exa_regex=({src_resource_type}volume|[Ii]nstance)Id\\?":\s*\\?"({src_resource}[^",]+)\\?"""
  """exa_json_path=$.requestParameters.description,exa_field_name=description"""
  """exa_json_path=$.responseElements.ownerId,exa_field_name=owner_id"""
  """exa_json_path=$.responseElements.snapshotId,exa_field_name=resource_id"""
  ]
