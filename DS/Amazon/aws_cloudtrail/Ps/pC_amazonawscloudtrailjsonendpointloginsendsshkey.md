...
```Java
{
Name = amazon-awscloudtrail-json-endpoint-login-sendsshkey
  Vendor = Amazon
  ...
  Fields = ${AwsParserTemplates.aws-cloudtrail-json.Fields}[
    """exa_json_path=$.requestParameters.instanceId,exa_field_name=resource_id""",
    """"userIdentity":\{("[^,]+,)*"accountId\\?"+\s*:\s*\\?"+?({account_id}[^"]+?)\\?"""",
