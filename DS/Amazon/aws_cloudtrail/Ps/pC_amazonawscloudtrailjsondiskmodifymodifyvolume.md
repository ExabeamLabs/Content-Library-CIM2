...
```Java
{
Name = amazon-awscloudtrail-json-disk-modify-modifyvolume
  Vendor = Amazon
  ...
  """exa_json_path=$.requestParameters..VolumeId,exa_field_name=resource_id"""
  """exa_json_path=$.requestParameters..volumeType,exa_field_name=volume_type"""
  """exa_json_path=$..originalMultiAttachEnabled,exa_field_name=old_multiattach"""
  """exa_json_path=$..targetMultiAttachEnabled,exa_field_name=new_multiattach"""
  """exa_json_path=$.responseElements..originalSize,exa_field_name=old_size"""
  """exa_json_path=$.responseElements..targetSize,exa_field_name=new_size"""
  """exa_json_path=$.requestParameters..VolumeType,exa_field_name=volume_type"""
  ]
