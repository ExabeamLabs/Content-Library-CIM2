...
```Java
{
Name = amazon-awscloudtrail-json-bucket-create-awsapicall
  Vendor = Amazon
  ...
  """exa_json_path=$.requestParameters.CreateBucketConfiguration.LocationConstraint,exa_field_name=arn""",
