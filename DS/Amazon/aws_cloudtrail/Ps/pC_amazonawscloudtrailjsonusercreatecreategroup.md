...
Name = amazon-awscloudtrail-json-user-create-creategroup
  ...
  Fields = ${AwsParserTemplates.aws-cloudtrail-json.Fields}[
    """exa_json_path=$.responseElements.group.groupName,exa_field_name=identities""",
    """exa_json_path=$.responseElements.group.groupId,exa_field_name=role_id""",
    """exa_json_path=$.responseElements.group.arn,exa_field_name=role_arn"""
  ]
