...
```Java
{
Name = amazon-awscloudtrail-json-disk-create-createvolume
  Vendor = Amazon
  ...
  """exa_json_path=$.requestParameters.size,exa_field_name=volume_size""",
  """exa_json_path=$.requestParameters.zone,exa_field_name=volume_zone""",
  """exa_json_path=$.requestParameters.volumeType,exa_field_name=volume_type""",
  """exa_json_path=$.requestParameters.snapshotId,exa_field_name=src_resource""",
  """exa_json_path=$.responseElements.volumeId,exa_field_name=resource_id""",
  """exa_regex="key":"Name","value":"({disk_name}[^"]+)"(,|\}|\])"""
  ]
