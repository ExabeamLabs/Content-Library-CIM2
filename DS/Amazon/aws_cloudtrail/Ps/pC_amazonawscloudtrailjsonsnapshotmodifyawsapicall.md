...
```Java
{
Name = amazon-awscloudtrail-json-snapshot-modify-awsapicall
  Vendor = Amazon
  ...
  """exa_json_path=$.requestParameters.snapshotId,exa_field_name=resource_id""",
  """exa_json_path=$.requestParameters.createVolumePermission.add.items,exa_field_name=added_users""",
  """exa_json_path=$.requestParameters.createVolumePermission.remove.items,exa_field_name=removed_users"""
  ]
