...
```Java
{
Name = amazon-awscloudtrail-json-bucket-permission-modify-putbucketacl
  Vendor = Amazon
  ...
  Fields = ${AwsParserTemplates.aws-cloudtrail-json.Fields}[
    ...
    """exa_json_path=$..AccessControlList.Grant[*]..xsi:type,exa_field_name=allowed_user_types""",
    """exa_json_path=$..AccessControlList.Grant[*]..ID,exa_field_name=allowed_ids""",
    """exa_json_path=$..AccessControlList.Grant[*]..URI,exa_field_name=allowed_uris""",
    """exa_json_path=$..AccessControlList.Grant[*]..Permission,exa_field_name=allowed_permissions""",
    """exa_json_path=$..AccessControlPolicy.Owner.ID,exa_field_name=owner_id""",
