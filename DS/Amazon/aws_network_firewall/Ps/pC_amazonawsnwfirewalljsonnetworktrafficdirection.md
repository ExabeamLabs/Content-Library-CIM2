...
Name = amazon-awsnwfirewall-json-network-traffic-direction
    ...
    Fields = [
       ...
       """exa_json_path=$.event.src_ip,exa_regex=({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))""",
       """exa_json_path=$.event.src_port,exa_field_name=src_port""",
       """exa_json_path=$.event.dest_ip,exa_regex=({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))""",
