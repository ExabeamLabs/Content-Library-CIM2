...
Name = amazon-awsguardduty-sk4-alert-trigger-success-guardduty-3
  ...
  Fields = [
    ...
    """"type":"({alert_type}[^"]+)""",
    """"resource":[^=]+?privateIpAddress":"({dest_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?""",
    """"remoteIpDetails[^=]+?"ipAddressV4":"({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?""",
