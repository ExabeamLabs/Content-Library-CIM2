...
Name = snowflake-s-json-database-activity-success-querytext
  ...
  Fields = [
    ...
    """exa_json_path=$.WAREHOUSE_NAME,exa_field_name=db_name"""
    ...
    """exa_json_path=$.QUERY_TYPE,exa_regex=({db_operation}[^"]+)"""
    """exa_json_path=$.USER_NAME,exa_field_name=db_user"""
    """exa_json_path=$.ROLE_NAME,exa_field_name=role"""
  ]
