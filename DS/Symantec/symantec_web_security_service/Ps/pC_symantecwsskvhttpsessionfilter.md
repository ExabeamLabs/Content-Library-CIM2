...
"""\W(c-ip|src)="?(-|({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?)"""
"""\tr-ip=(-|({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?)"""
"""\Wsrcport=(-|({src_port}\d+))"""
"""\Wdst=(-|({dest_ip}({external_dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))))"""
"""\Wdstport=(?:-|({dest_port}\d+))"""
"""\W(cs-username|username)="?(-|({user}[\w\.\-\!\#\^\~]{1,40}\$?))\s*("|\||$|\t|\s+[\w\-\(\)]+=)"""
"""\Ws-action="?(-|({proxy_action}[^"|]+))\s*("|\||$|\t|\s+[\w\-\(\)]+=)"""
"""\W(sc|cs)-status="?(-|({http_response_code}\d+))\s*("|\||$|\t|\s+[\w\-\(\)]+=)"""
"""\Wcs-method="?((unknown)|-|({method}[^"|]+))\s*("|\||$|\t|\s+[\w\-\(\)]+=)"""
...
"""\W(sc-)?filter-category="?(none|-|({category}[^"|]+))\s*("|\||$|\t|\s+[\w\-\(\)]+=)"""
"""\Wcs-categories="?(none|-|({categories}({category}[^"|;]+)[^"|]*))"?\s*("|\||$|\t|;|\s+[\w\-\(\)]+=)"""
"""\Wcs-categories="?(none|-|({categories}({category}[^;"]+)[^"|]*))"?\s*("|\||$|\t|\s+[\w\-\(\)]+=)"""
