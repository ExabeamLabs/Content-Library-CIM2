...
Name = symantec-endpointprotection-kv-alert-trigger-success-alerttriggered
  ...
  Fields = [
    ...
    """,\s*Local Host IP:\s*(0.0.0.0|({local_host_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4})))""",
    """,\s*Remote Host IP:\s*(0.0.0.0|({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4})))""",
