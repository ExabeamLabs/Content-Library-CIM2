...
Name = symantec-endpointprotection-csv-alert-trigger-success-virusfound
  ...
  Fields = ${SymantecParsersTemplates.symantec-alert-jp.Fields}[
    ...
    """送信元 IP:\s*({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?""",
...
symantec-alert-jp = {
  ...
  Fields = [
    ...
    """,IP アドレス:\s*({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?""",
