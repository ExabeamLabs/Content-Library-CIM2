...
TimeFormat = ["yyyy-MM-dd HH:mm:ss","yyyy-MM-dd HH:mm:ssZ"]
Conditions = [
  """Local:"""
  """Remote:"""
  """Rule:"""
...
Fields = [
  ...
  """,Remote:\s*(0.0.0.0|({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?),Remote:\s*(|({dest_host}[\w\-\.]+)),Remote:\s*({=dest_port}\d+),"""
