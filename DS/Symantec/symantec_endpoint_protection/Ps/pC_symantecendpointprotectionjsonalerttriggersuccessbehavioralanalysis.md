...
```Java
{
Name = symantec-endpointprotection-json-alert-trigger-success-behavioralanalysis
  ExtractionType =json
  ParserVersion = "v1.0.0"
  Conditions = [ """"feature_name":"BEHAVIORAL_ANALYSIS"""", """"type":"HOST_PROCESS_DETECTION"""", """"product_name":"Symantec Endpoint """ ]
  Fields = ${SymantecParsersTemplates.json-symantec-endpoint-protection.Fields}[
    ...
    """exa_json_path=$.threat.name,exa_field_name=alert_name"""
    """exa_json_path=$.feature_name,exa_field_name=alert_type"""
    """exa_json_path=$.severity_id,exa_field_name=alert_severity"""
    """exa_regex="attacks":\[({attack_info}.+?\})\]""",
    """exa_regex=cmd_line":"({process_command_line}[^\n]+?)\s*",""",
