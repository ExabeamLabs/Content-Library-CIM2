...
```Java
{
Name = symantec-edr-json-app-notification-success-liveupdatesession
  ParserVersion = "v1.0.0"
  Conditions = [ """"A LiveUpdate session ran successfully""",""""Symantec""" ]
  Fields = ${DLSymantecParserTemplates.symantec-system-info-template.Fields}[
    """({event_name}A LiveUpdate session ran successfully)""",
