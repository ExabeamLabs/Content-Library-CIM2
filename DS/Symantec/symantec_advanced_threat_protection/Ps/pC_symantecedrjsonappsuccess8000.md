...
```Java
{
Name = symantec-edr-json-app-success-8000
  ParserVersion = v1.0.0
  ExtractionType = json
  Conditions = [ """"product_name":"Symantec Endpoint""", """"event_data_type":"fdr"""",""""type_id":8000""" ]
  Fields = ${SymantecParserTemplates.symantec-parser-template.Fields}[
    """exa_json_path=$.edr_enriched_data.category_name,exa_field_name=event_name""",
