...
```Java
{
Name = checkpoint-tp-kv-alert-trigger-success-actionprevent
  Product = SmartDefense
  ParserVersion = v1.0.0
  start_timeFormat = "epoch_sec"
  Conditions = [ """product:"New Anti Virus"""" , """action:"Prevent"""", """smartdefense_profile""" ]
  Fields = ${CheckpointParsersTemplates.checkpoint-network-alert.Fields}[ 
  ...
  """malware_rule_id:"({rule_id}[^"]+)""",
  """malware_rule_name:"({rule}[^"]+)""",
