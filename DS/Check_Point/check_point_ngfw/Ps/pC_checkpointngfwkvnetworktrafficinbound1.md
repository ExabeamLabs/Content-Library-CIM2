...
```Java
{
Name = checkpoint-ngfw-kv-network-traffic-inbound-1
  ParserVersion = "v1.0.0"
  Conditions = [ """ CheckPoint """, """; originsicname:"""", """; ifdir:"inbound";""", """; product:""" ]
...
checkpoint-firewall-2 = {
  ...
  Fields = [
    ...
    """\W(src|client_ip)(=|:)"*({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?""",
    """\Wxlatesrc:"({src_translated_ip}[A-Fa-f:\d.]+)""",
    """\Wdst:"({dest_translated_ip}[A-Fa-f:\d.]+).+?xlatedst:"(0\.0\.0\.0|({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?)""",
    """\Wdst(=|:)"*({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?.+?xlatedst:"({dest_translated_ip}0\.0\.0\.0)""",
