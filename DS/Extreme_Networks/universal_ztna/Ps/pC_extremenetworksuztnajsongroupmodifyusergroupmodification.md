...
```Java
{
Name = extremenetworks-uztna-json-group-modify-usergroupmodification
  Conditions = [ """"event":"USER_GROUP_MODIFICATION"""", """"event_type":"""", """"event_status":"""", """"performed_by":"""" ]
  Fields = ${ExtremeNetworksParserTemplates.json-extremenetworks-uztna-event.Fields}[
    """exa_json_path=$.user_group_details.user_group_name,exa_field_name=group_name""",  
    """exa_json_path=$.user_group_details.old_name,exa_field_name=group_name""",
    """exa_json_path=$.user_group_details.added_users,exa_field_name=added_users"""    
  ]
...
json-extremenetworks-uztna-event = {
  ...
  Fields = [
    ...
    """exa_json_path=$.origin,exa_regex=({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?""",
