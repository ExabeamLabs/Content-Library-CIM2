...
```Java
{
Name = extremenetworks-pone-json-user-add-success
  ParserVersion = "v1.0.0"
  Conditions = [ """"operation_name":"user.add"""", """"operation_detail":""", """"timestamp":""", """"operation_context":{""", """"category":""" ]
  Fields = ${ExtremeNetworksParserTemplates.json-extremenetworks-pone-event.Fields} [
    """exa_json_path=$.operation_context.username,exa_field_name=added_users""",
  ]
