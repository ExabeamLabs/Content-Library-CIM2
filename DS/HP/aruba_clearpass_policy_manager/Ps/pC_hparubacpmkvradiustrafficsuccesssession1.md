...
```Java
{
Name = hp-arubacpm-kv-radius-traffic-success-session-1
  Conditions = [ """ LEEF:""", """|Aruba Networks|ClearPass|""", """ cat=Session Logs""", """|messageId=""", """ RADIUS.Acct-Username=""", """cat=Session Logs""" ]
