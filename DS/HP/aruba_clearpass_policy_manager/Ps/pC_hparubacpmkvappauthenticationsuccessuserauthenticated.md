...
```Java
{
Name = hp-arubacpm-kv-app-authentication-success-userauthenticated
  Conditions = [ """ LEEF:""", """|Aruba Networks|ClearPass|""", """ cat=Insight Logs""", """|[User Authenticated] """, """Auth.Login-Status=""", """ Auth.Roles=""" ]
