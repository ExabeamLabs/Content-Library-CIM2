...
```Java
{
Name = hp-arubacpm-kv-endpoint-authentication-tacacsaccounting_tacacs_authentication
  ParserVersion = "v1.0.0"
  Conditions = [ """TacacsAccounting""", """TACACS.Request-Type=TACACS_AUTHENTICATION""", """,TACACS.Session-Log-Timestamp""" ]
