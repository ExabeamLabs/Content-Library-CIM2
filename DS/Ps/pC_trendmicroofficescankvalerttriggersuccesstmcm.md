...
```Java
{
Name = "trendmicro-officescan-kv-alert-trigger-success-tmcm"
Conditions = [
"""TMCM:SLF_INCIDENT_EVT_VIRUS_FOUND_CLEAN_SUCCESS"""
]
...
cef-trendmicro-security-alert = {
  ...
  Fields = [
    ...
    """\Wdpt=({dest_port}\d+)""",
    """\Wsrc=(::|({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?)\s""",
    """\Wspt=({src_port}\d+)""",
