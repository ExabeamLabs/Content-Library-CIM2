...
```Java
{
Name = zyxel-usgflex-kv-network-notification-success-msg
  ParserVersion = "v1.0.0"
  Conditions = [ """ msg="""", """ note=""", """ cat="""", """ devID="""" ]
...
zyxel-network-events = {
    ...
    Fields = [
      ...
      """\suser="(?:unknown|({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|({user}[\w\.\-\!\#\^\~]{1,40}\$?))""""
