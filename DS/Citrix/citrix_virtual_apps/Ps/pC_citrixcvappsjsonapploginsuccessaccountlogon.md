...
```Java
{
Name = citrix-cvapps-json-app-login-success-accountlogon
  ParserVersion = v1.0.0
  Product =  Citrix Virtual Apps
  Conditions = [ """"occurrence_event_type":"Account.Logon"""", """"entity_type":"user"""", """"product":"Citrix Virtual Apps and Desktops"""" ]
