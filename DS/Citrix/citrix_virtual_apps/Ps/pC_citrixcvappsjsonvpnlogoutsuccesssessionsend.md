...
```Java
{
Name = citrix-cvapps-json-vpn-logout-success-sessionsend
  ParserVersion = v1.0.0
  Product =  Citrix Virtual Apps
  Conditions = [ """"occurrence_event_type":"Session.End"""", """"entity_type":"user"""", """"product":"Citrix Virtual Apps and Desktops"""" ]
