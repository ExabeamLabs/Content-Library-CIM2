...
```Java
{
Name = citrix-cgateway-json-vpn-login-logout-success
    ParserVersion = v1.0.0
    Vendor = Citrix
    Product = Citrix Gateway
    ExtractionType = json
    TimeFormat = "yyyy-MM-dd'T'HH:mm:ssZ" 
    Conditions = [ """"action":"""", """"Vendor":"Citrix"""","""NetScaler SSLVPN""" ]
    Fields = [
      """exa_json_path=$.@timestamp,exa_field_name=time""",
      """exa_json_path=$.vpn_client_type,exa_field_name=vpn_client_type""",
