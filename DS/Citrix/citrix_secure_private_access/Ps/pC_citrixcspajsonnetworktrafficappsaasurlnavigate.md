...
```Java
{
Name = citrix-cspa-json-network-traffic-appsaasurlnavigate
  ParserVersion = v1.0.0
  Product =  Citrix Secure Private Access
  Conditions = [ """"occurrence_event_type":"App.SaaS.Url.Navigate"""", """"entity_type":"user"""", """"product":"Citrix Secure Private Access"""" ]
