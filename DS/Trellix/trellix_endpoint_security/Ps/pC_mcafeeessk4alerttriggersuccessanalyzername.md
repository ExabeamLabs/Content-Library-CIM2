...
Name = mcafee-es-sk4-alert-trigger-success-analyzername
  ...
  Fields = [
    ...
    """"sourceipv6":\{[^\}]+?"value":"\/?({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?"""",
    """"sourceipv4":\{[^\}]+?"value":"({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?"""",
    ...
    """"targetusername":\{[^\}]+?"value":"((NT SERVICE|({domain}[^"\\]+))\\+)?({user}[\w\.\-\!\#\^\~]{1,40}\$?)"""",
    """"sourceusername":\{[^\}]+?"value":"((NT SERVICE|({domain}[^"\\]+))\\+)?({user}[\w\.\-\!\#\^\~]{1,40}\$?)"""",
