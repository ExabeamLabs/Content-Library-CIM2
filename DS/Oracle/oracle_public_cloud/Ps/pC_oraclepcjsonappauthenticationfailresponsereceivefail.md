...
```Java
{
Name = oracle-pc-json-app-authentication-fail-responsereceivefail
  ParserVersion = "v1.0.0"
  Conditions = [ """"ssoAuthnLevel":""", """"serviceName":"SAML"""", """"eventId":"saml.sp.sso.response.received.failure"""" ]
