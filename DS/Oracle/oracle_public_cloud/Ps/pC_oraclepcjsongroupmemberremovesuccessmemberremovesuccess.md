...
```Java
{
Name = oracle-pc-json-group-member-remove-success-memberremovesuccess
  ParserVersion = "v1.0.0"
  Conditions = [ """"adminResourceType":"""", """"serviceName":"Admin"""", """"eventId":"admin.group.remove.member.success"""" ]
