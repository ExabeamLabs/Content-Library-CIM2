...
```Java
{
Name = oracle-pc-json-app-activity-success-objectupdateuccess
  ParserVersion = "v1.0.0"
  Conditions = [ """"adminResourceType":"""", """"serviceName":"job"""", """"eventId":"admin.accountobjectclass.update.success"""" ]
