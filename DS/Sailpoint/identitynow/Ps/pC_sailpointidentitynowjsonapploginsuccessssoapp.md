...
Name = sailpoint-identitynow-json-app-login-success-ssoapp
  ...
  Fields = ${SailPointParserTemplates.s-sailpoint-activity.Fields} [
    ...
    """exa_json_path=$.info,exa_regex=((?i:null|NONE)|({result}[^"]+))$""",
  ]
...
s-sailpoint-activity = {
  ...
  Fields = [
    ...
    """exa_json_path=$.ipaddr,exa_regex=({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?""",
