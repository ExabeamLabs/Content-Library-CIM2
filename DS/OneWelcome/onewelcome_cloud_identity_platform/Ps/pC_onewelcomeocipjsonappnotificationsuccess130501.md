...
```Java
{
Name = onewelcome-ocip-json-app-notification-success-130501
  Conditions = [ """"originator":"onewelcome"""", """"siemcode":"130501"""", """"authres":"MODFAIL"""", """"pepmod":"iwauth"""", """"type":"pep_auth"""", """"peptype":"AUTH-RES"""" ]
...
onewelcome-authentication-event = {
    ...
    Fields = [
      ...
      """exa_json_path=$.account,exa_regex=(-|({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|({user}[\w\.\-\!\#\^\~]{1,40}\$?)(@({domain}[^"]+))?)""",
