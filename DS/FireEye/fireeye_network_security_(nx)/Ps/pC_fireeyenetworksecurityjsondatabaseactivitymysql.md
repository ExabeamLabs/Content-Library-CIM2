...
```Java
{
Name = "fireeye-networksecurity-json-database-activity-mysql"
	Conditions = [ """"event_type":"mysql"""", """"flow_id":""", """"mysql":{""", """"command":""", """"success":""" ]
  	Fields = ${FireEyeParsersTemplates.fireeye-networksecurity-nx-events.Fields}[
  	  """exa_json_path=$.mysql.command,exa_field_name=operation""",
  	  """exa_json_path=$.mysql.success,exa_field_name=result"""
    ]
