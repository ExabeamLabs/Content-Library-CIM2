...
Name = pan-gp-cef-app-notification-success-panos
  ...
  Fields = [
    ...
    """PanOSSourceUserName =(({domain}[^\\=]+)\\+)?({user}[^=]+?)\s\w+=""",
    """PanOSPrivateIPv(4|6)=({dest_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))""",
    """PanOSPublicIPv(4|6)=({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))""",
