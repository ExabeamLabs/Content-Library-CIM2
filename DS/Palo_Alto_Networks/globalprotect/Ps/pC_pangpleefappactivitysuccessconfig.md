...
```Java
{
Name = pan-gp-leef-app-activity-success-config
 Conditions = [ """Palo Alto Networks""", """_paloalto""", """PAN-OS Syslog Integration""", """cat=CONFIG""" ]
 ParserVersion = "v1.0.0"
 Fields = ${PaloAltoParsersTemplates.leef-paloalto-vpn-event-1.Fields}[
