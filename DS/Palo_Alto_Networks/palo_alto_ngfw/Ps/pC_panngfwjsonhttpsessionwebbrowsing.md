...
""""ContentType":"({mime}[^"]+)""""
""""URL":"({web_domain}[^\/]*?({top_domain}[^\.]+\.(com|net|ms|app|edu|org|gov|co|jp|ru|de|ir|it|in|fr|info|pl|nl|es|gr|cz|eu|tv|me|jp|ca|cn|uk|my|cc|id|us|nz|biz|pub||club|io|gg|fi|au|st|tw|asia|sg|ie|li|za|co\.uk|to)))\/""""
]
