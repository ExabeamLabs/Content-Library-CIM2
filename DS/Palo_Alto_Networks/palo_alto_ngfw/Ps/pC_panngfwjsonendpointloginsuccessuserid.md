...
```Java
{
Name = "pan-ngfw-json-endpoint-login-success-userid"
Conditions = [ """"LogType":"USERID"""", """"DeviceSN":"""", """"Subtype":"login"""", """"AuthFactorNo":"""]
...
paloalto-vpn.Fields}[
    ...
    """exa_json_path=$..NATSource,exa_regex=({src_translated_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))"""
    """exa_json_path=$..NATDestination,exa_regex=({dest_translated_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))"""
...
Fields = [
  ...
  """exa_json_path=$..DestinationAddress,exa_regex=({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?"""
...
Fields = [
"""'PaSeries @ ({src_host}[^\s']+)( \(({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?\))?'"""
