...
Fields = [
  ...
  """\|srcPostNAT=(0\.0\.0\.0|({src_translated_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4})))\|"""
  """\|dstPostNAT=(0\.0\.0\.0|({dest_translated_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4})))\|"""
  """\|RuleName =({rule}[^\|]*?)\|"""
