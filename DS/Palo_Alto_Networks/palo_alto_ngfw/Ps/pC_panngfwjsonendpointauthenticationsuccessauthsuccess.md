...
```Java
{
Name = pan-ngfw-json-endpoint-authentication-success-authsuccess
 Conditions = [ """"LogType":"SYSTEM"""", """"Subtype":"auth"""", """"EventName":"auth-success""""]
 Fields = ${DLPaloAltoParserTemplates.json-pan-system.Fields}[
   """exa_json_path=$.EventDescription,exa_regex=From:\s*(({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?)""",
   ...
   """exa_json_path=$.EventComponent,exa_field_name=auth_method""",
 ]
