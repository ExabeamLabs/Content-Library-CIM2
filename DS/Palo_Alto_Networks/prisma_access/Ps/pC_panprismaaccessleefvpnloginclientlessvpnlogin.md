...
```Java
{
Name = pan-prismaaccess-leef-vpn-login-clientlessvpnlogin
 Conditions = [ """LEEF:""", """|Palo Alto Networks|""", """|Prisma Access|""", """cat=globalprotect""", """SubType=globalprotect""", """|clientlessvpn-login|""" ]
