...
```Java
{
Name = monday-mon-json-app-activity-catchall
  Vendor = Monday.com
  Product = Monday.com
  ExtractionType = json
  TimeFormat = ["yyyy-MM-dd'T'HH:mm:ss.SSSZ"]
  Conditions = [ """"timestamp":""", """"account_id":""", """"user_id":""", """"event":""", """"slug":""", """"user_agent":""" ]
  Fields = [
    ...
    """exa_json_path=$.slug,exa_field_name=account_name""",
    """exa_json_path=$.ip_address,exa_field_name=src_ip""",
    """exa_json_path=$.user_agent,exa_field_name=user_agent""",
    """exa_json_path=$.client_name,exa_field_name=client_name"""
    ...
    """exa_json_path=$.activity_metadata,exa_field_name=activity_details"""
  ]
