...
```Java
{
Name = secureauth-login-kv-app-authentication-fail-22610
  ParserVersion = "v1.0.0"
  Conditions = [ """LogChannel="SA_AUDIT" """, """StateMachineID=""", """RequestID=""", """ApplianceID=""", """UserID=""", """EventID="22610"""", """ValidateUser Failed - attempts:""" ]
