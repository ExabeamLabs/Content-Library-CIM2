...
```Java
{
Name = code42-incydr-json-peripheral-storage-insert-success-deviceappeared
Vendor = "Code42"
...
Fields = [
  ...
  """exa_json_path=$.detectionDevice.serialNumber,exa_field_name=usb_serial_number,exa_match_expr=!InList(toLower($.detectionDevice.serialNumber), "unknown")"""
