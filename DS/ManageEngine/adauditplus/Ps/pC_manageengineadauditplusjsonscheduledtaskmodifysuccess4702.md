...
```Java
{
Name = manageengine-adauditplus-json-scheduled-task-modify-success-4702
  ParserVersion = "v1.0.0"
  Conditions = [ """"EVENT_NUMBER":"4702"""", """"A scheduled task was updated."""" ]
  Fields = ${ADAuditParserTemplates.ad-audit-plus-json-events.Fields}[
    """exa_json_path=$.FILE_NAME,exa_regex=^({file_path}({file_dir}[^"]+)\\+({file_name}[^"]+))$"""
    """exa_json_path=$.PRIMARY_LOGON_ID,exa_field_name=login_id"""
