...
```Java
{
Name = checkmarx-checkm-json-user-modify-success-userupdated
  ParserVersion = v1.0.0
  Conditions = [ """"Type": "UserUpdated"""", """"UserName":""", """"UserId":""", """"Details":""" ]
  Fields = ${CheckmarxParserTemplates.checkmarx-json-template.Fields}[
    """exa_json_path=$.Details,exa_regex=\\?"Id\\?":\s*({dest_user_id}\d+)""",
    """exa_json_path=$.Details,exa_regex=\\?"AuthenticationProvider\\?":[^\}]+?\\?"Name\\?":\s*\\?"({auth_process}[^\\"]+)\\?""""
  ]
