...
```Java
{
Name = checkmarx-checkm-json-user-password-modify-success-passwordchanged
  ParserVersion = v1.0.0
  Conditions = [ """"Type": "PasswordChanged"""", """"UserName":""", """"UserId":""", """"Details":"""  ]
  Fields = ${CheckmarxParserTemplates.checkmarx-json-template.Fields}[
    """exa_json_path=$.Details,exa_regex=\\?"Info\\?":\s*\\?"({additional_info}[^\\"]+)\\?""""
  ]
