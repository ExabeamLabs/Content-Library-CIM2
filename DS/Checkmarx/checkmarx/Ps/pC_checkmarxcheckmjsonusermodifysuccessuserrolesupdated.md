...
```Java
{
Name = checkmarx-checkm-json-user-modify-success-userrolesupdated
  ParserVersion = v1.0.0
  Conditions = [ """"Type": "UserRolesUpdated"""", """"UserName":""", """"UserId":""", """"Details":""" ]
  Fields = ${CheckmarxParserTemplates.checkmarx-json-template.Fields}[
    """exa_json_path=$.Details,exa_regex=\\?"RolesRemoved\\?":[^\]]+\\?"Name\\?":\s*\\?"({removed_role_name}[^\\"]+)\\?""""
  ]
