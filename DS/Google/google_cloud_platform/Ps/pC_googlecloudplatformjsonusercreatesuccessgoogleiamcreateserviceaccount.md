...
Name = google-cloudplatform-json-user-create-success-googleiamcreateserviceaccount
  ...
  Fields = ${GcpParserTemplates.gcp-cloudaudit-json.Fields}[
    """exa_json_path=$.protoPayload.request.service_account.display_name,exa_field_name=account_name""",
    """exa_json_path=$.resource.labels.email_id,exa_field_name=account_email"""
  ]
