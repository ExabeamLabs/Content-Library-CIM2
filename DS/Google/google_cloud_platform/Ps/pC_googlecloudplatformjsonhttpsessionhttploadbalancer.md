...
Name = google-cloudplatform-json-http-session-httploadbalancer
  ...
  Conditions = [""""type":"http_load_balancer"""",  """"requestMethod":"""","""dproc=Cloud PubSub"""]
  Fields = [
    ...
    """"remoteIp":"({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?""",
	  ...
	  """"serverIp":"({dest_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?""",
