...
```Java
{
Name = google-cloudplatform-json-endpoint-modify-success-computeinstancessetmetadata
  ...
  Fields = ${GcpParserTemplates.gcp-cloudaudit-json.Fields}[
    """exa_json_path=$.protoPayload.metadata.instanceMetadataDelta.addedMetadataKeys,exa_field_name=added_keys""",
    """exa_json_path=$.protoPayload.metadata.instanceMetadataDelta.modifiedMetadataKeys,exa_field_name=modified_keys"""
  ]
...
gcp-cloudaudit-json = {
    ...
    """exa_json_path=$..requestMetadata.callerIp,exa_regex=({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?""",
    """exa_json_path=$..access.callerIp,exa_regex=({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?"""",
