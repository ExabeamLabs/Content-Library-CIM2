...
Name = google-geminient-json-ai_agent-request-modelarmor
  ...
  Conditions = [ """modelarmor.googleapis.com""", """"sanitizationInput":""", """"sanitizationResult":""", """"sanitizationVerdict":""" ]
  Fields = [
    ...
    """exa_json_path=$..sanitizationInput.text,exa_field_name=llm_request"""
