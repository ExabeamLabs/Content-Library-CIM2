...
```Java
{
Name = google-workspace-sk4-app-success-activity
  ParserVersion = v1.0.0
  Conditions = [ """"kind"""", """"applicationName":"token"""", """"uniqueQualifier":""", """"name":"activity"""" ]
  Fields = ${GoogleParsersTemplates.cef-google-app-activity.Fields} [
    """"events":.*?"name":"method_name"[^\}]+?"value":"({event_name}({operation}[^"]+?))""""
  ]
