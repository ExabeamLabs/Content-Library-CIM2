...
```Java
{
Name = cloudflare-insights-json-http-response-edgeresponsestatus
  Vendor = Cloudflare
  Product = Cloudflare Insights
  ParserVersion = "v1.0.0"
  ExtractionType = json
  TimeFormat = "yyyy-MM-dd'T'HH:mm:ssZ"
  Conditions = [ """destinationServiceName =Cloudflare""", """"EdgeResponseStatus":""", """"ClientRequestMethod":"""" ]
  Fields = [
    ...
    """exa_json_path=$.ClientRequestURI,exa_regex=({uri_path}[^"\?\s]+)(?:\?({uri_query}[^?\s"]+))?"""
