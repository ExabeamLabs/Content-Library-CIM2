...
```Java
{
Name = sentinelone-singularityp-json-handle-copy-success-duplicatethreadhandle
  ExtractionType = json
  ParserVersion = "v1.0.0"
  Conditions = [ """"dataSource.name":"SentinelOne"""", """"event.category":"cross_process"""", """"event.type":"Duplicate Thread Handle"""" ]
