...
```Java
{
Name = "sentinelone-singularityp-json-alert-trigger-success-datasourcecategorysecurity"
  ExtractionType = json
  Conditions = [ """"dataSource.category":"security"""", """vendor_name":"SentinelOne"""", """"dataSource.name":"alert"""", """"finding_info.title":""" ]
