...
```Java
{
Name = sentinelone-singularityp-json-process-create-success-processcreation-2
  ParserVersion = "v1.0.0"
  Conditions = [ """"s1ql":""", """"targetProcessInfo":""", """"eventType":"PROCESSCREATION"""", """"incidentStatus":""" ]
  Fields = ${SentinelOneParsersTemplates.sentinelone-json-api-alerts.Fields} [
    """exa_json_path=$.targetProcessInfo.tgtProcCmdLine,exa_field_name=dest_process_command_line""",
    """exa_json_path=$.targetProcessInfo.tgtProcImagePath,exa_field_name=dest_process_path""",
    """exa_json_path=$.targetProcessInfo.tgtProcName,exa_field_name=dest_process_name"""
  ]
