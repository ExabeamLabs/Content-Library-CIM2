...
```Java
{
Name = sentinelone-singularityp-json-file-write-success-filecreation
  ParserVersion = "v1.0.0"
  Conditions = [ """"s1ql":""", """"eventType":"FILECREATION"""", """"incidentStatus":""" ]
  Fields = ${SentinelOneParsersTemplates.sentinelone-json-api-alerts.Fields} [
    ...
    """exa_json_path=$.targetProcessInfo.tgtFilePath,exa_field_name=({file_path}([^"]+[\\\/]+)?({file_name}[^\\\/"]+))""" 
  ]
