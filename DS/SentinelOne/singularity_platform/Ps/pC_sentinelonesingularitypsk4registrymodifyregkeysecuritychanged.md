...
```Java
{
Name = sentinelone-singularityp-sk4-registry-modify-regkeysecuritychanged
  ParserVersion = "v1.0.0"
  Product = Singularity Platform
  Conditions = [ """timestamp {""", """millisecondsSinceEpoch: """, """trueContext {""", """isRedirectedCommandProcessor: """, """regKeySecurityChanged {""" , """regKey {""", """path:""" ]
