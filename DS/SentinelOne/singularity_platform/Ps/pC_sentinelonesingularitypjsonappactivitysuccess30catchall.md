...
```Java
{
Name = sentinelone-singularityp-json-app-activity-success-30-catchall
  ParserVersion = v1.0.0
  Conditions = [ """"primaryDescription":""", """"activityType":30""", """"activityUuid":""", """"threatId":""" ]
  Fields = ${SentinelOneParsersTemplates.json-sentinelone-activitytype.Fields} [
    """exa_json_path=$..fileContentHashSha256,exa_field_name=hash_sha256"""
  ]
