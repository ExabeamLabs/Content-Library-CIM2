...
```Java
{
Name = "sentinelone-singularityp-json-configuration-modify-success-activity_type3752"
  ParserVersion = "v1.0.0"
  Conditions = [ """"dataSource.vendor":"SentinelOne"""", """"activity_type":3752,""", """primary_description":"""", """"type":"""" ]
  Fields = ${SentinelOneParsersTemplates.json-sentinelone-activity_type.Fields} [
    """exa_regex="data.user_name":"(({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+?)|({user}[\w\.\-\!\#\^\~]{1,40}\$?))""""
