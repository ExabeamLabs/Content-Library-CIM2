...
```Java
{
Name = "sentinelone-singularityp-json-alert-trigger-success-datasourcecategorysecurity-1"
  ExtractionType = json
  Conditions = [ """"dataSource.category":"security"""", """vendor_name":"SentinelOne"""", """"dataSource.name":"vulnerability"""", """"finding_info.title":""" ]
