...
```Java
{
Name = sentinelone-singularityp-json-dns-request-success-dns
  ParserVersion = "v1.0.0"
  Conditions = [ """"s1ql":""", """"eventType":"DNS"""", """"dnsRequest":""", """"dnsResponse":""" ]
  Fields = ${SentinelOneParsersTemplates.sentinelone-json-api-alerts.Fields} [
    """exa_json_path=$..dnsRequest,exa_field_name=dns_query""",
    """exa_json_path=$..dnsResponse,exa_field_name=dns_response"""
  ]
