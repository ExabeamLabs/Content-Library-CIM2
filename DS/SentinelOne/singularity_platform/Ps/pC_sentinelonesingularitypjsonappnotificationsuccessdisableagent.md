...
```Java
{
Name = sentinelone-singularityp-json-app-notification-success-disableagent
  ParserVersion = v1.0.0
  Conditions = [ """"primaryDescription":""", """"activityType":""", """"activityUuid":""", """"threatId":""", """issued a Disable Agent command""" ]
  Fields = ${SentinelOneParsersTemplates.json-sentinelone-activitytype.Fields} [
    """exa_json_path=$.primaryDescription,exa_regex=(.+?({alert_name}issued a Disable Agent command))"""
  ]
...
json-sentinelone-activitytype = {
  ...
  """exa_json_path=$..fileContentHash,exa_regex=^(({hash_sha256}\w{64})|({hash_sha1}\w{40})|({hash_md5}\w{32}))$""",
