...
"""exa_regex="fileContentHash":\s*"(({hash_md5}\w{32})|({hash_sha1}\w{40})|({hash_sha256}\w{64}))""""
...
"""exa_regex="agentIp":\s*"({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?"""
