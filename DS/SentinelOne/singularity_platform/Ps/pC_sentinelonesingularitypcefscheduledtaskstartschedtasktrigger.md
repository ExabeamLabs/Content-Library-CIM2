...
```Java
{
Name = sentinelone-singularityp-cef-scheduled-task-start-schedtasktrigger
  ParserVersion = v1.0.0
  Product = Singularity Platform
  Conditions = [ """timestamp {""", """millisecondsSinceEpoch: """, """trueContext {""", """isRedirectedCommandProcessor: """, """taskName:""", """schedTaskTrigger {""" ]
