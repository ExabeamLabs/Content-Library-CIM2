...
```Java
{
Name = wiz-w-csv-endpoint-notification-success-rotateserviceaccount
 ParserVersion = "v1.0.0"
 Conditions = [ """,RotateServiceAccountSecret,""", """,SERVICE_ACCOUNT,""", """"ID""""]
 Fields = ${WizParserTemplates.wiz-system-info-events.Fields}[
   """({event_name}RotateServiceAccountSecret)"""
   ]
