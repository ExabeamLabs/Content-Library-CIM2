...
```Java
{
Name = wiz-w-csv-endpoint-notification-success-runissueautomation
 ParserVersion = "v1.0.0"
 Conditions = [ """,RunIssuesAutomationAction,""", """,USER_ACCOUNT,""", """"actionId"""" ]
 Fields = ${WizParserTemplates.wiz-system-info-events.Fields}[
   """({event_name}RunIssuesAutomationAction)"""
   ]
