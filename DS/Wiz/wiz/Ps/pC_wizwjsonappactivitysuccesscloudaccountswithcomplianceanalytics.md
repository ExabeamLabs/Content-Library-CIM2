...
```Java
{
Name = wiz-w-json-app-activity-success-cloudaccountswithcomplianceanalytics
 ParserVersion = "v1.0.0"
 Conditions = [ """"action":"CloudAccountsWithComplianceAnalytics"""", """"actionParameters":""" , """"serviceAccount":""" ]
 Fields = ${WizParserTemplates.wiz-w-json-audit-log.Fields}[
   """exa_json_path=$.serviceAccount.name,exa_field_name=report"""
   ]
...
wiz-w-json-audit-log = {
  ...
  Product = Wiz
  ExtractionType = json
  TimeFormat = ["yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ","yyyy-MM-dd'T'HH:mm:ss.SSSSSZ","yyyy-MM-dd'T'HH:mm:ss.SSSSSSSZ"]
  Fields = [
