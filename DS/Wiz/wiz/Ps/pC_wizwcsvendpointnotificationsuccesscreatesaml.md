...
```Java
{
Name = wiz-w-csv-endpoint-notification-success-createsaml
 ParserVersion = "v1.0.0"
 Conditions = [ """,CreateSAMLIdentityProvider,""", """,USER_ACCOUNT,""", """"loginURL"""" ]
 Fields = ${WizParserTemplates.wiz-system-info-events.Fields}[
   """({event_name}CreateSAMLIdentityProvider)"""
   ]
