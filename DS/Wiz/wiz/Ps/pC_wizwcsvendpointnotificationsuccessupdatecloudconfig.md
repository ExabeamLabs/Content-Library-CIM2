...
```Java
{
Name = wiz-w-csv-endpoint-notification-success-updatecloudconfig
 ParserVersion = "v1.0.0"
 Conditions = [ """,UpdateCloudConfigurationRule,""", """,USER_ACCOUNT,""", """"id"""" ]
 Fields = ${WizParserTemplates.wiz-system-info-events.Fields}[
   """({event_name}UpdateCloudConfigurationRule)"""
   ]
