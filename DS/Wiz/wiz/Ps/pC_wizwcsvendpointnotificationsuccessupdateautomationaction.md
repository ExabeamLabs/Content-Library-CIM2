...
```Java
{
Name = wiz-w-csv-endpoint-notification-success-updateautomationaction
 ParserVersion = "v1.0.0"
 Conditions = [ """,UpdateAutomationAction,""", """,USER_ACCOUNT,""", """"name"""" ]
 Fields = ${WizParserTemplates.wiz-system-info-events.Fields}[
   """({event_name}UpdateAutomationAction)"""
   ]
