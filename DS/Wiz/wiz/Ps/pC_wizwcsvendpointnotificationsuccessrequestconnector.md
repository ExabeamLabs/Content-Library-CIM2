...
```Java
{
Name = wiz-w-csv-endpoint-notification-success-requestconnector
 ParserVersion = "v1.0.0"
 Conditions = [ """,RequestConnectorEntityScan,""", """,USER_ACCOUNT,""", """"type"""" ]
 Fields = ${WizParserTemplates.wiz-system-info-events.Fields}[
   """({event_name}RequestConnectorEntityScan)"""
   ]
