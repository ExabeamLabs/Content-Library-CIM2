...
""":"""
    ...
    Fields = [
      ...
      """"from"+:\s*\[?"+?({full_name}[^"@\s,<>]+\s+[^"@,<>]+?)?\s*\<?(\\u\d+)?({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|\>]+)>*"],""",
      """"envelope":.+?"from":"({full_name}[^"@\s,<>]+\s+[^"@,<>]+?)?\s*\<?(\\u\d+)?({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|\>]+)>*"""",
      """"message-id":.+?"subject"+:\s*\["+({email_subject}[^"]+?\])""",
      """"msg":\{.+?"header".+?"subject":\["({email_subject}[^"]+?)"\]""",
      """"msg".+?"normalizedHeader":.+?"subject":\["({email_subject}[^"]+?)"\]"""
      """"rcpts"+:\s*\[({email_recipients}"({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))[^\]]*?)"\]""",
      """"verified"+:\{[^\}]*"rcpts"+:\s*\["({email_recipients}({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))[^\]]*?)"\]""",
      ...
      """"msgParts":\[\{[^\n]*"md5":"({hash_md5}[^"]+)"[^\n]*\],""",
      """"msgParts":\[\{[^\n]*"sha256":"({hash_sha256}[^"]+)"[^\n]*(\],|\}\])""",
      """"msg".+?normalizedHeader":.+?"reply-to":\["(({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|({dest_user}[\w\.\-]{1,40}\$?|({dest_user_full_name}\w+(\s+\w+)+)))"]""",
      """"msg".+?"normalizedHeader":.+?"from"+:\s*\[?"+?({full_name}[^"@\s,<>]+\s+[^"@,<>]+?)?\s*\<?(\\u\d+)?({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|\>]+)>?"?\]?,""""
      """"country":"({country}[^"]+)""",
      ...
      """"smtp.mailfrom":"({mailfrom}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+)""""
      ...
      """exa_regex="from"+:\s*\[?"+?({full_name}[^"@\s,<>]+\s+[^"@,<>]+?)?\s*\<?(\\u\d+)?({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|\>]+)>*"],""",
      """exa_json_path=$.envelope.from,exa_regex=({full_name}[^"@\s,<>]+\s+[^"@,<>]+?)?\s*\<?(\\u\d+)?({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|\>]+)>*($|")""",
      """exa_json_path=$.msg.normalizedHeader.subject[1:],exa_field_name=email_subject""",
      """exa_json_path=$.envelope.rcpts[1:],exa_regex=({email_recipients}"({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))[^\]]*?)""",
      """exa_json_path=$.filter.verified.rcpts[1:],exa_regex=({email_recipients}"({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))[^\]]*?)""",
      ...
      """exa_regex="rcpts"+:\s*\["({email_recipients}({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))[^\]]*?)\]""",
      """exa_regex="verified"+:\{[^\}]*"rcpts"+:\s*\["({email_recipients}({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))[^\]]*?)"\]""",
      ...
      """exa_json_path=$.msg.sizeBytes,exa_field_name=bytes""",
	    """exa_regex="msgParts":\[\{[^\n]*"md5":"({hash_md5}[^"]+)"[^\n]*\],""",
      """exa_regex="msgParts":\[\{[^\n]*"sha256":"({hash_sha256}[^"]+)"[^\n]*(\],|\}\])""",
      """exa_regex="msg".+?"normalizedHeader":.+?"from"+:\s*\[?"+?({full_name}[^"@\s,<>]+\s+[^"@,<>]+?)?\s*\<?(\\u\d+)?({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|\>]+)>?"?\]?,""""
      ...
      """exa_json_path=$..['smtp.mailfrom'],exa_regex=({mailfrom}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+)$""",
