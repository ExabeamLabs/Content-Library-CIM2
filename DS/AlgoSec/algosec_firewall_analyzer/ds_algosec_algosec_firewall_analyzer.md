...
|:----:| ---- | ---- | ---- |
| [Compromised Credentials](../../../UseCases/uc_compromised_credentials.md) |  alert-trigger:success(network-alert)<br> ↳[algosec-fa-cef-alert-trigger-success-unauthorizedtraffic](Ps/pC_algosecfacefalerttriggersuccessunauthorizedtraffic.md)<br> | T1027 - Obfuscated Files or Information<br>T1027.005 - Obfuscated Files or Information: Indicator Removal from Tools<br>T1190 - Exploit Public Fasing Application<br> | [<ul><li>21 Rules</li></ul><ul><li>9 Models</li></ul>](RM/r_m_algosec_algosec_firewall_analyzer_Compromised_Credentials.md) |
|    [Malware](../../../UseCases/uc_malware.md)    |  alert-trigger:success(network-alert)<br> ↳[algosec-fa-cef-alert-trigger-success-unauthorizedtraffic](Ps/pC_algosecfacefalerttriggersuccessunauthorizedtraffic.md)<br> | TA0002 - TA0002<br>    | [<ul><li>4 Rules</li></ul><ul><li>2 Models</li></ul>](RM/r_m_algosec_algosec_firewall_analyzer_Malware.md)    |
