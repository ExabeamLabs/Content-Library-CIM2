...
```Java
{
Name = okta-amfg-json-endpoint-login-success-authviaradius
  ParserVersion = v1.0.0
  ExtractionType = json
  Conditions = [ """"legacyEventType":"core.user_auth.radius.login""", """"eventType":"user.authentication.auth_via_radius"""" ]
