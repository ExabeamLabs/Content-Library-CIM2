...
Name = okta-amfa-sk4-group-member-add-success-adduser
  ...
  Fields=[
    ...
    """"actor":\{[^\}]*?("type":"User",)?"alternateId":"((({user}[\w\.\-\!\#\^\~]{1,40}\$?)@({domain}[^\s"]+?\.corp))|({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|unknown|({=user}[\w\.\-\!\#\^\~]{1,40}\$?))"""",
    ...
    """"target":\[[^\]]*?("type":"User",)?"alternateId":"(({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|unknown|({account_name}({dest_user}[\w\.\-\!\#\^\~]{1,40}\$?)))"""",
    ...
    """duser=(({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|unknown|({user}[\w\.\-\!\#\^\~]{1,40}\$?))\s*""",
    ...
    """exa_json_path=$.target[1:].alternateId,exa_regex=(({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|unknown|({user}[\w\.\-\!\#\^\~]{1,40}\$?)),exa_match_expr=Contains($.target.type,"User")""",
    ...
    """exa_regex="actor":\{[^\}]*?("type":"User",)?"alternateId":"((({user}[\w\.\-\!\#\^\~]{1,40}\$?)@({domain}[^\s"]+?\.corp))|({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|unknown|({=user}[\w\.\-\!\#\^\~]{1,40}\$?))"""",
    ...
    """exa_json_path=$.target[?(@.type == 'User')].alternateId,exa_regex=(({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|unknown|({account_name}({dest_user}[\w\.\-\!\#\^\~]{1,40}\$?)))""",
