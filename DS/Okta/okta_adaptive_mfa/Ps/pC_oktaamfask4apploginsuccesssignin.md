...
```Java
{
Name = okta-amfa-sk4-app-login-success-signin
...
json-okta-failed-app-login = {
    ...
    Fields = [
      ...
      """exa_json_path=$.result.IPAddress,exa_regex=({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?"""
...
q-okta-app-login = {
  ...
  Fields = [
    ...
    """"displayName"+:"+(Unknown|RSA-OKTA Admin|AD-OKTA Admin|({full_name}[^"]+))",[^\{\}]*?"objectType"+:"+User"""",
    """"login"+:"+({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))[^\{\}]*?"objectType"+:"+User"""",
    ...
    """exa_regex="login"+:"+({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))[^\{\}]*?"objectType"+:"+User""""
    """exa_json_path=$.actors[*].ipAddress,exa_field_name=src_ip""",
    """exa_json_path=$.actors[*].login,exa_regex=(?:(({user}[\w\.\-\!\#\^\~]{1,40}\$?)@({domain}[^\s"]+?\.corp))|({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+)))"""
...
#============================================== Start of OktaParsers section ==================================================================
OktaParsers = [

${OktaParserTemplates.json-okta-auth}{
