...
```Java
{
Name = "okta-amfa-cef-app-login-success-appadloginsuccess"
  ParserVersion = "v1.0.0"
  ExtractionType = json
  Conditions = [ """"legacyEventType":"app.ad.login.success"""" , """"eventType":"user.authentication.auth_via_AD_agent"""", """"result":"SUCCESS""""]
