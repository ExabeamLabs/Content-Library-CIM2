...
```Java
{
Name = "liquidfiles-l-json-network-notification-success-bruteforcecount"
  ParserVersion = v1.0.0
  ExtractionType = json
  Conditions = [ """liquidfiles[""", """"message":"Client with IP:""", """bruteforce detection count""" ]
  Fields = ${LiquidFilesParserTemplates.Liquid-json-template.Fields}[
    """Client with IP:\s*({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))"""
  ]
