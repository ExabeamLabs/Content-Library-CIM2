...
```Java
{
Name = "questsoftware-caad-json-file-write-success-filecontentwritten"
  Conditions = [
  """"event": "EMC File contents written""""
  """"action": "Other""""
  """"folderPath": """"
  """"timeDetected": """"
  ]
...
quest-caad-json-file-events = {
    ...
    Fields = [
      ...
      """exa_json_path=$.originIPv4,exa_regex=({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?""",
