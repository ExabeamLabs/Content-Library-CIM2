...
Name = kaspersky-endpointsecurity-xml-alert-trigger-success-security
  ...
  Fields = [
    ...
    """<Row>(<Cell ss:StyleID="TableData"><Data ss:Type=[^\<]+?>(<\/Cell>|[^\<]+?<\/Data><\/Cell>)){13}<Cell ss:StyleID="TableData"><Data ss:Type=[^\<]+?>({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?<\/Data><\/Cell>""",
