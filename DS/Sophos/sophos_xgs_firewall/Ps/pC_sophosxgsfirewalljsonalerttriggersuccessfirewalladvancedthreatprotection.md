...
```Java
{
Name = sophos-xgsfirewall-json-alert-trigger-success-firewalladvancedthreatprotection
  Product = Sophos XGS Firewall
  Conditions = [ """"Event::Firewall::FirewallAdvancedThreatProtection""", """"location":""", """"type":""" ]
