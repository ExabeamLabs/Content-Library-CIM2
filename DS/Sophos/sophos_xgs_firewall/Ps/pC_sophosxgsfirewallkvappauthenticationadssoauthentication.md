...
```Java
{
Name = sophos-xgsfirewall-kv-app-authentication-adssoauthentication
  Product = Sophos XGS Firewall
  Conditions = [ """log_component="AD SSO"""", """log_type="Event"""", """log_subtype="Authentication"""", """ NTLM authentication channel """ ]
