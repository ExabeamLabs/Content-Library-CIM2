...
```Java
{
Name = sophos-xgsfirewall-kv-vpn-logout-sslvpnauthentication
  Product = Sophos XGS Firewall
  Conditions = [ """log_component="Firewall Authentication"""", """log_type="Event"""", """client_used="SSLVPN"""", """log_subtype="Authentication"""", """ logged out """ ]
