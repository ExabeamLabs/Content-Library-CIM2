...
```Java
{
Name = crowdstrike-falcon-json-peripheral_device-activity-success-usb
  ParserVersion = "v1.0.0"
  TimeFormat = "epoch"
  Conditions = [ """"vendor":"CrowdStrike"""", """"product":"Falcon FDR"""", """"EventType":"DataEgressEnriched"""", """"Channel":"usb"""" ]
  Fields = ${CrowdStrikeParsersTemplates.json-crowdstrike-falcon-dataegressenriched.Fields}[
    """exa_json_path=$.Destination.USBSerialNumber,exa_field_name=usb_serial_number""",
    """exa_json_path=$.Destination.USBVendorName,exa_field_name=usb_vendor""",
    """exa_json_path=$.Destination.USBProductName,exa_field_name=device_product"""
  ]
