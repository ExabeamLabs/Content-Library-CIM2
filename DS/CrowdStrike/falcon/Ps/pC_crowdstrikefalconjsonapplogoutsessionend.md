...
```Java
{
Name = crowdstrike-falcon-json-app-logout-sessionend
  ExtractionType = json
  ParserVersion = "v1.0.0"
  Conditions = [""""eventType":""", """RemoteResponseSessionEndEvent""", """"UserName":"""]
...
json-crowdstrike-app-logout = {
  ...
  Fields = [
    ...
    """exa_json_path=$.event.UserName,exa_regex=({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))""",
