...
```Java
{
Name = crowdstrike-falcon-json-printer-activity-success-printer
  ParserVersion = "v1.0.0"
  TimeFormat = "epoch"
  Conditions = [ """"vendor":"CrowdStrike"""", """"product":"Falcon FDR"""", """"EventType":"DataEgressEnriched"""", """"Channel":"printer"""" ]
