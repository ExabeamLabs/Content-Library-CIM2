...
""""event_simpleName":"NetworkConnectIP""" 
  ...
  Fields = [
    ...
    """"aip":\s*"({aip}[^"]+)"""",
    """ConnectionDirection":"({direction}1)",.+?"LocalAddress":\s*"({dest_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))","LocalPort":"*({dest_port}\d+)"*,.+?"RemoteAddress":"({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?","RemotePort":\s*"*({=src_port}\d+)"""",
"""ConnectionDirection":"({direction}0)",.+?"LocalAddress":\s*"({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))","LocalPort":"*({src_port}\d+)"*,.+?"RemoteAddress":"({dest_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?","RemotePort":\s*"*({=dest_port}\d+)"""",
