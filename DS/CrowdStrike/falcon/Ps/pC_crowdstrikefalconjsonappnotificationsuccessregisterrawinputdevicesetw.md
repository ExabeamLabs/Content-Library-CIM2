...
Name = crowdstrike-falcon-json-app-notification-success-registerrawinputdevicesetw
  ...
  Conditions = [ """"aid":""", """"aip":""", """"event_simpleName":"RegisterRawInputDevicesEtw"""", """"event_platform":"""" ]
...
crowdstrike-json-app-notification = {
  ...
  Fields = [
    ...
    """exa_json_path=$.UserPrincipal,exa_regex=({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))""",
