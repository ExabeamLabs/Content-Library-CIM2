...
```Java
{
Name = crowdstrike-falcon-sk4-user-password-reset-success-requestresetpassword
  Product = Falcon
  ParserVersion = v1.0.0
  Conditions = [ """"event-name":""", """"audit-event"""", """"OperationName":"requestResetPassword"""" ]
...
crowdstrike-app-activity = {
    ...
    Fields = [
      ...
      """"UserId":\s*"(({email_address}[^"@]+@({email_domain}[^"@]+))|({user}[\w\.\-]{1,40}\$?))"""",
