...
```Java
{
Name = 1password-1pwd-json-app-activity-action
  ParserVersion = v1.0.0
  Vendor = 1password
  Product = 1password
  ExtractionType = json
  TimeFormat = ["yyyy-MM-dd'T'HH:mm:ssZ", "yyyy-MM-dd'T'HH:mm:ss.SSSZ"]
  Conditions = [ """"account_uuid":""", """"app_name":""", """"action":""", """"vault_uuid":""" ]
  Fields = [
    """exa_json_path=$.timestamp,exa_field_name=time""",
    """exa_json_path=$.client.app_name,exa_field_name=app""",
    """exa_json_path=$.client.os_name,exa_field_name=os""",
    """exa_json_path=$.client.os_version,exa_field_name=os_version""",
    """exa_json_path=$.client.platform_name,exa_field_name=browser""",
