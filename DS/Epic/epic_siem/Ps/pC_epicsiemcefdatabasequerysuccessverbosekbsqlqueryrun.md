...
```Java
{
Name = epic-siem-cef-database-query-success-verbosekbsqlqueryrun
  ParserVersion = "v1.0.0"
  Product = Epic SIEM
  Conditions = [ """CEF:""", """|Epic|Security-SIEM|""", """|VERBOSE_KB_SQL_QUERY_RUN|""" ]
  Fields = ${EpicParsersTemplates.cef-epic-app-activity.Fields} [
    """KBQUERYTEXT=({db_query}.+?)\s+(\w+=|$)"""
    """KBQUERYNAME=({db_operation}.+?)\s+(\w+=|$)"""    
  ]
