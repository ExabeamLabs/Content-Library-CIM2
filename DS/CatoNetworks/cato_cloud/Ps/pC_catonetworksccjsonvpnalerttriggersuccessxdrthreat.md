...
```Java
{
Name = "catonetworks-cc-json-vpn-alert-trigger-success-xdrthreat"
Conditions = [ """"event_type":""", """"Detection and Response"""", """"event_sub_type":""", """"XDR Threat"""", """"vpn_user_email":""" ]
   Fields = ${CatonetworkParsersTemplates.json-catonetwork.Fields}[
