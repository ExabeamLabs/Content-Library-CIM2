...
```Java
{
Name = atlassian-bitbucket-json-app-activity-success-prcommentreply
  ParserVersion = "v1.0.0"
  Conditions = [ """"actionI18nKey"""", """atlassian-bitbucket-audit""" ,""""action":"Pull request comment reply added""""]
