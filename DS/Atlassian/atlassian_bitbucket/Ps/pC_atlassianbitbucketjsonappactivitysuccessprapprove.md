...
```Java
{
Name = atlassian-bitbucket-json-app-activity-success-prapprove
  ParserVersion = "v1.0.0"
  Conditions = [ """"actionI18nKey"""", """atlassian-bitbucket-audit""" ,""""action":"Pull request approved by participant""""]
