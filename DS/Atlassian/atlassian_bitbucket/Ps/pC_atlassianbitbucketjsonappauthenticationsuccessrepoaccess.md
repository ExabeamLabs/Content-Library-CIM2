...
```Java
{
Name = atlassian-bitbucket-json-app-authentication-success-repoaccess
  ParserVersion = "v1.0.0"
  Conditions = [ """"actionI18nKey"""", """atlassian-bitbucket-audit""" ,""""action":"Repository accessed by user""""]
