...
```Java
{
Name = atlassian-bitbucket-json-configuration-modify-success-hooksettingchange
  ParserVersion = "v1.0.0"
  Conditions = [ """"actionI18nKey"""", """atlassian-bitbucket-audit""" ,""""action":"Repository hook settings changed for repository""""]
