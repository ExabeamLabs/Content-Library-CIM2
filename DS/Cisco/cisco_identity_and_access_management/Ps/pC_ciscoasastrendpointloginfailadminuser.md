...
Name = "cisco-asa-str-endpoint-login-fail-adminuser"
  ...
  Fields = [
  """({additional_info}Authentication failed for admin user) '({user}[\w\.\-\!\#\^\~]{1,40}\$?)' on ({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?"""
