...
Name = cisco-netsec-json-network-traffic-success-categorytype
  ...
  Fields = [
    ...
    """exa_json_path=$.scope.devices[:1].url,exa_field_name=url""",
    """exa_json_path=$.scope.devices[:1].productType,exa_field_name=device_type""",
    """exa_json_path=$.scope.devices[:1].serial,exa_field_name=device_id""",
    """exa_json_path=$.scope.devices[:1].mac,exa_field_name=src_mac"""
  ]
