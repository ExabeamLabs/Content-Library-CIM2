...
"""\s(({host}[\w.\-]+))\s+([-\s:]+)?%ASA""",
    ...
    """Built inbound ICMP.*?faddr\s+(({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4})|([A-Fa-f0-9%.]*:[A-Fa-f0-9%.:]+(th0)?))(\/({src_port}\d+)?)|({src_host}[\w-\.]+))(\(({domain}[^\\]+)\\({user}[\w\.\-\!\#\^\~]{1,40}\$?)\))?""",
    """Built outbound ICMP.*?laddr\s+(({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4})|([A-Fa-f0-9%.]*:[A-Fa-f0-9%.:]+(th0)?))|({src_host}[^\s]+?))((\/({src_port}\d+)(\(|\s+))|\s+)""",
    """Built inbound ICMP.*?laddr\s+(({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4})|([A-Fa-f0-9%.]*:[A-Fa-f0-9%.:]+(th0)?))|({dest_host}[^\s]+?))((\/({dest_port}\d+)(\(|\s+))|\s+)""",
