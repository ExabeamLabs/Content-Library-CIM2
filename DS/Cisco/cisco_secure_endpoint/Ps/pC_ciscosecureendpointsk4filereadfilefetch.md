...
```Java
{
Name = cisco-secureendpoint-sk4-file-read-filefetch
  ParserVersion = v1.0.0
  Product = Cisco Secure Endpoint
  Conditions = [ """"event_type"""", """"File Fetch""", """"trajectory":""", """"timestamp_nanoseconds":""" ]
  Fields = ${DLCiscoParsersTemplates.s-cisco-amp-alert.Fields}[
    """"event_type":"File Fetch ({result}[^"]+)"""
  ]
...
s-cisco-amp-alert = {
  ...
  Fields = [
    ...
    """external_ip":\s*"({dest_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?""",
    """"network_addresses":.+?"ip":\s*"({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?""",
