...
```Java
{
Name = cisco-secureendpoint-sk4-file-restore-success-falsepositive
  ParserVersion = v1.0.0
  Product = Cisco Secure Endpoint
  Conditions = [ """"event_type"""", """"Cloud Recall Restore of False Positive"""", """"trajectory":""", """"timestamp_nanoseconds":""" ]
