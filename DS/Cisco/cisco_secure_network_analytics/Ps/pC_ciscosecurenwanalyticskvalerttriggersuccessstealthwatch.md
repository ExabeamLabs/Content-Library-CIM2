...
"""\|port(=|\|)({dest_port}\d+)"""
"""\|target_ip(=|\|)({dest_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?"""
...
"""\|device_ip(=|\|)({host_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))"""
"""\|device_name(=|\|)({host}[^|]+)\|"""
"""\|details(=|\|)(|({details}[^|]+))\|"""
