...
Name = cisco-duo-json-endpoint-authentication-result-1
  ...
  Fields = [
    ...
    """"reason":"({result_reason}[^"]+)"[^=]+?"result":"success"""",
    """"result":"success"[^=]+?"reason":"({result_reason}[^"]+)"""",
    """"os":"({os}[^"]+)"""",
    ...
    """"access_device":\{.*?"location":\{[^\}]*?"city":"(null|({city}[^"]+))"""",
    """"access_device":\{.*?"location":\{[^\}]*?"state":"(null|({state}[^"]+))"""",
    ...
    """"auth_device":\{.*?"location":\{[^\}]*?"state":"(null|({location_state}[^"]+))"""",
    """"auth_device":\{.*?"location":\{[^\}]*?"city":"(null|({location_city}[^"]+))"""",
    ...
    """exa_json_path=$.reason,exa_field_name=result_reason,exa_match_expr=InList(toLower($.result), "success")""",
    ...
    """exa_json_path=$.access_device.location.city,exa_field_name=city""",
    """exa_json_path=$.access_device.location.state,exa_field_name=state""",
    ...
    """exa_json_path=$.auth_device.location.state,exa_field_name=location_state,exa_match_expr=!Contains($.auth_device.location.state,"null")""",
    """exa_json_path=$.auth_device.location.city,exa_field_name=location_city,exa_match_expr=!Contains($.auth_device.location.city,"null")""",
