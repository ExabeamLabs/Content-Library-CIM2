...
```Java
{
Name = forcepoint-ngfw-cef-network-close-70022
  ParserVersion = "v1.0.0"
  Conditions = [ """CEF:""", """|FORCEPOINT|Firewall|""","""|70022|Connection_Closed-Abnormally|""" ]
...
forcepoint-template-1= {
  ...
  Fields=[
    ...
    """dvchost=({host_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))""",
    """act=({action}[^=]+)\s\w+=""",
