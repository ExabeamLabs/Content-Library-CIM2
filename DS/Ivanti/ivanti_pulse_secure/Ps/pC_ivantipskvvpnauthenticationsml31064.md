...
```Java
{
Name = ivanti-ps-kv-vpn-authentication-sml31064
  Conditions = [ """ PulseSecure: """, """SML31064""", """ type=vpnssl """, """SAML Consumer received and processed""" ]
  Fields = ${JuniperParsersTemplates.ivanti-pulsesecure-events.Fields}[
    """({event_name}SAML Consumer received and processed)\s+'({method}[^']+)'""",
    """Result:\s*({result}\w+)"""
  ]
