...
```Java
{
Name = ivanti-ps-kv-vpn-authentication-success-aut31266
    Conditions = ["""PulseSecure:""", """AUT31266""", """type=vpn""", """OCSP checking successfully passed""" ]
    Fields = ${JuniperParsersTemplates.ivanti-pulsesecure-events.Fields}[
	    """({event_name}OCSP checking successfully passed)"""
    ]
