...
```Java
{
Name = ivanti-ps-kv-vpn-authentication-fail-aut31487
  Conditions = [ """ PulseSecure: """, """AUT31487""", """ type=vpnssl """, """Terminated SSL handshake""" ]
  Fields = ${JuniperParsersTemplates.ivanti-pulsesecure-events.Fields}[
    """({event_name}Terminated SSL handshake) with client: ({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))""",
