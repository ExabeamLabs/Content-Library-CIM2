...
```Java
{
Name = ivanti-ps-kv-vpn-authentication-success-aut30544
    Conditions = ["""PulseSecure:""", """AUT30544""", """type=vpn""", """proto=auth""", """User chose to proceed""" ]
    Fields = ${JuniperParsersTemplates.ivanti-pulsesecure-events.Fields}[
	    """({event_name}User chose to proceed[^"]+)"""
    ]
