...
```Java
{
Name = ivanti-ps-kv-vpn-authentication-success-jav32168
  Conditions = [ """ PulseSecure: """, """JAV32168""", """ type=vpnssl """, """Connect Request Received """ ]
  Fields = ${JuniperParsersTemplates.ivanti-pulsesecure-events.Fields}[
    """({event_name}Connect Request Received) from Client port ({src_port}\d+) for ({dest_host}[\w\-.]+) port ({dest_port}\d+)"""
  ]
