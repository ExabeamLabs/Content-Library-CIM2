...
```Java
{
Name = ivanti-ps-kv-vpn-authentication-success-sml31067
  Conditions = [ """ PulseSecure: """, """SML31067""", """ type=vpnssl """, """SAML AuthnRequest generation succeeded""" ]
  Fields = ${JuniperParsersTemplates.ivanti-pulsesecure-events.Fields}[
    """\sSigninUrl:'({url}[^']+)'""",
    """({event_name}SAML AuthnRequest generation succeeded)"""
  ]
