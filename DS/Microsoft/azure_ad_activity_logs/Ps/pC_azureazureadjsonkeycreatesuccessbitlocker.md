...
```Java
{
Name = azure-azuread-json-key-create-success-bitlocker
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Add BitLocker key""", """"category":""", """"KeyManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_regex=({event_name}Add BitLocker key)""",
