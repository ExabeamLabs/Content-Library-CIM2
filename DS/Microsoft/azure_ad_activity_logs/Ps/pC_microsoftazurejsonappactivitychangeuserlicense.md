...
```Java
{
Name = microsoft-azure-json-app-activity-changeuserlicense
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Change user license"""", """"operationType":""", """"Update"""", """"targetResources":""", """"category":""", """"UserManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_json_path=$.targetResources[:1].userPrincipalNam,exa_field_name=object"""
  ]
