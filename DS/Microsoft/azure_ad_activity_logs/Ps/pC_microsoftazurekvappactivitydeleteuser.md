...
```Java
{
Name = microsoft-azure-kv-app-activity-deleteuser
  ...
  Fields = ${MSParsersTemplates.ms-azure-eventhubs-activity.Fields}[
    ...
    """"ipAddress":\s*"?(null|({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?)"?"""
    """exa_regex="ipAddress":\s*"?(null|({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?)"?"""
  ]
