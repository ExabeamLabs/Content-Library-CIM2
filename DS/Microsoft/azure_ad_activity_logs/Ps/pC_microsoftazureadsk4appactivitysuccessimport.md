...
```Java
{
Name = microsoft-azuread-sk4-app-activity-success-import
  ParserVersion = "v1.0.0"
  Conditions = [ """"AuditLogs"""", """"Category":""", """"ProvisioningManagement"""", """"OperationName":""", """"Import"""" ]
  Fields = ${LMSMSParsersTemplates.cef-azure-audit.Fields} [
    """"ResultDescription":\s*"({additional_info}[^"]+)""",
    """({event_name}({category}ProvisioningManagement))"""
  ]
