...
```Java
{
Name = azure-azuread-json-app-activity-updateuser
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Update user""", """"operationType":""", """"Update"""", """"targetResources":""", """"category":""", """"UserManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_regex=({event_name}Update user)""",
