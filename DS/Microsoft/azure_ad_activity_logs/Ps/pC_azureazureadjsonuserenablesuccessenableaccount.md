...
```Java
{
Name = azure-azuread-json-user-enable-success-enableaccount
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Enable account""", """"operationType":""", """"Update"""", """"targetResources":""", """"category":""", """"UserManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_regex=({event_name}Enable account)""",
