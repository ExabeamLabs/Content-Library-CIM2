...
```Java
{
Name = azure-azuread-json-key-read-success-bitlocker
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Read BitLocker key""", """"category":""", """"KeyManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_regex=({event_name}Read BitLocker key)""",
