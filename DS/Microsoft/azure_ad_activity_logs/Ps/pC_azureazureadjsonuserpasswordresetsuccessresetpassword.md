...
```Java
{
Name = azure-azuread-json-user-password-reset-success-resetpassword
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Reset user password""", """"operationType":""", """"Update"""", """"targetResources":""", """"category":""", """"UserManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_regex=({event_name}Reset user password)""",
