...
"""targetResources"+:\s*\[\{([^,]+,){3}"+userPrincipalName"+:\s*"+(({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|({dest_user}({member}[^"]+)))""""
...
"""exa_regex="userPrincipalName(\\)?":\s*(\\)?"({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))"""
...
"""exa_regex=targetResources"+:\s*\[\{([^,]+,){3}"+userPrincipalName"+:\s*"+(({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))|({dest_user}({member}[^"]+)))""""
