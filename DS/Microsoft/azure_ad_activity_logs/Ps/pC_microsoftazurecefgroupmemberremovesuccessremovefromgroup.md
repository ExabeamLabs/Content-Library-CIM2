...
"""\\*"type\\*":\\*"User\\",\\*"userPrincipalName\\*":\s*\\*"({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))\\*(,|")"""
...
"""exa_regex=\\*"type\\*":\\*"User\\",\\*"userPrincipalName\\*":\s*\\*"({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))\\*(,|")"""
