...
```Java
{
Name = azure-azuread-json-user-password-modify-success-selfservice-1
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Self-service password reset""", """"operationType":""", """"Update"""", """"targetResources":""", """"category":""", """"UserManagement"""" ]
