...
```Java
{
Name = azure-azuread-json-app-activity-addownertoapplication
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Add owner to application""", """"operationType":""", """"Assign"""", """"targetResources":""", """"category":""", """"ApplicationManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_regex=({event_name}Add owner to application)""",
