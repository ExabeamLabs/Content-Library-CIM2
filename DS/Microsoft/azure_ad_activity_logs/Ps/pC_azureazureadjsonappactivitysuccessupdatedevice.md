...
```Java
{
Name = azure-azuread-json-app-activity-success-updatedevice
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Update device""", """"operationType":""", """"Update"""", """"targetResources":""", """"category":""", """"Device"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_regex=({event_name}Update device)""",
