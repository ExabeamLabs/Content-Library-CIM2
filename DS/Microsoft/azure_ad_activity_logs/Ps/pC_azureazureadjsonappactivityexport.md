...
```Java
{
Name = azure-azuread-json-app-activity-export
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Export""", """"operationType":""", """"targetResources":""", """"category":""", """"ProvisioningManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_regex=({event_name}Export)""",
