...
```Java
{
Name = azure-azuread-json-group-modify-success-updategroup
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Update group""", """"operationType":""", """"Update"""", """"targetResources":""", """"category":""", """"GroupManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_regex=({event_name}Update group)""",
