...
```Java
{
Name = "microsoft-azuread-json-user-password-modify-success-changepassword"
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Change password (self-service)""", """"operationType":""", """"Update"""", """"targetResources":""", """"category":""", """"UserManagement"""" ]
