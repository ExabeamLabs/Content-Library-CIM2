...
```Java
{
Name = azure-azuread-json-user-password-reset-success-resetpasswordself
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Reset password (self-service)""", """"operationType":""" , """"Update"""", """"targetResources":""", """"category":""", """"UserManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_regex=({event_name}Reset password (self-service))""",
