...
```Java
{
Name = microsoft-o365-json-create-email-item-success
  ParserVersion = v1.0.0
  ExtractionType = json
  Conditions = [""""Operation":"Create"""", """"Workload":"Exchange"""" ]
  Fields = ${MSO365ParsersTemplates.m365-activity.Fields}[
    ...
    """exa_json_path=$.Item.Subject,exa_field_name=email_subject""",
    """exa_json_path=$.Item.ParentFolder.Path,exa_field_name=src_email_folder""",
    ...
    """exa_json_path=$.Item.Attachments,exa_field_name=attachment""",
    """exa_json_path=$.Item.InternetMessageId,exa_field_name=message_id""",
    """exa_json_path=$.Item.SizeInBytes,exa_field_name=bytes""",
    """exa_json_path=$.LogonUserSid,exa_field_name=user_sid""",
    """exa_json_path=$.UserKey,exa_regex=(anonymous|({user_id}[^@\"]+))""",
    """exa_json_path=$.Item.ParentFolder.Path,exa_regex=\\*({object}[^"]+)"""
  ]
