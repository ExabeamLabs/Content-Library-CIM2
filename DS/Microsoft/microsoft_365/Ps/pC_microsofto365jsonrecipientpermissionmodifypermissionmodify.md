...
Name = microsoft-o365-json-recipient-permission-modify-permissionmodify
  ...
  Fields = ${MSO365ParsersTemplates.m365-activity.Fields}[
    """/"Name":"Trustee","Value":"(({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)|(system|({dest_user}[\w\.\-\!\#\^\~]{1,40}\$?)))"\}"""",
    """"Value":"(({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)|(system|({dest_user}[\w\.\-\!\#\^\~]{1,40}\$?)))","Name":"Trustee"""",
