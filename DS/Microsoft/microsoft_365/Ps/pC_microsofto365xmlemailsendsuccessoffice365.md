...
Fields = [
  ...
  """<d:SenderAddress>({src_email_address}.+?)<\/d:SenderAddress>"""
  """<d:RecipientAddress>({dest_email_address}.+?)<\/d:RecipientAddress>"""
  ...
  """<d:FromIP>({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?<\/d:FromIP>"""
