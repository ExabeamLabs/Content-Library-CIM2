...
```Java
{
Name = microsoft-o365-json-role-create-success-addroledefinition
  ParserVersion = v1.0.0
  ExtractionType = json
  Conditions = [ """"Operation":"Add role definition."""", """"Workload":"AzureActiveDirectory"""" ]
  Fields = ${MSO365ParsersTemplates.m365-activity.Fields}[
    """"Name":"DisplayName",.*?"NewValue":"\[\\r\\n \\"({role_name}[^\\]+)\\"\\r\\n\]"""",
    """"NewValue":"\[\\r\\n \\"({role_name}[^\\]+)\\"\\r\\n\]",.*?"Name":"DisplayName"""",
    """"ObjectId\\*"+:"?[\s\\]*"+RoleDefinition_({role_id}[^"]+)",""",
    """"Name":"GrantedPermissions",.*?"NewValue":".+?\\"Actions\\":\s*\[\\r\\n\s*({permissions}\{\\r\\n\s*\\".+?\\r\\n\s*\})\\r\\n\s*\]""",
    """"NewValue":".+?\\"Actions\\":\s*\[\\r\\n\s*({permissions}\{\\r\\n\s*\\".+?\\r\\n\s*\})\\r\\n\s*\].*?,.*?"Name":"GrantedPermissions"""",
