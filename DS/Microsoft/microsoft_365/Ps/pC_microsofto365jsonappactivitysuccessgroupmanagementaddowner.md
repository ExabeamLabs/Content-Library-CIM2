...
```Java
{
Name = "microsoft-o365-json-app-activity-success-groupmanagementaddowner"
  Product = "Microsoft 365"
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Add owner to group"""", """"operationType":""", """"Assign"""", """"targetResources":""", """"category":""", """"GroupManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    """exa_json_path=$.targetResources[:1].modifiedProperties[?(@.displayName =='Group.DisplayName')].newValue,exa_field_name=group_name""",
    """exa_json_path=$.additionalDetails[:1].[?(@.key=='User-Agent')].value,exa_field_name=user_agent"""
  ]
