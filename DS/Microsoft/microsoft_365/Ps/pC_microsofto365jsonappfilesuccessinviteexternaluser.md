...
```Java
{
Name = microsoft-o365-json-app-file-success-inviteexternaluser
  Product = Microsoft 365
  ParserVersion = "v1.0.0"
  Conditions = [ """"activityDisplayName":""", """"Invite external user"""", """"operationType":""", """"Add"""", """"targetResources":""", """"category":""", """"UserManagement"""" ]
  Fields = ${MicrosoftParserTemplates.microsoft-azuread-json-events.Fields}[
    ...
    """exa_json_path=$.targetResources[:1].userPrincipalName,exa_field_name=target""",
  ]
