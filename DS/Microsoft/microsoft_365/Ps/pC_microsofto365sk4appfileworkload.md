...
"""exa_regex=\ssuser=(anonymous|SecurityComplianceAlerts|({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)|(Unknown|Sync|AirInvestigation|(\w+?_)?(\w+-)?\w+-\w+-\w+-\w+|({user}[\w\.\-\!\#\^\~]{1,40}\$?)))\s""",
"""exa_regex="Sender":"({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)"""",
"""exa_regex="Receivers":\[({email_recipients}"({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))[^\]]+?)\],"""",
"""exa_json_path=$..SourceFileName,exa_field_name=file_name"""
"""exa_json_path=$..ChatName,exa_field_name=object_name"""
"""exa_json_path=$..ItemName,exa_field_name=object_name"""
"""exa_json_path=$..SenderAddress,exa_regex=(<>|\\+|({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+))"""
...
"""exa_json_path=$..MailboxPrimaryAddress,exa_regex=({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)"""
"""exa_json_path=$..UserType,exa_field_name=user_type"""
"""exa_json_path=$..Severity,exa_field_name=alert_severity"""
"""exa_json_path=$..correlationId,exa_field_name=correlation_id"""
"""exa_json_path=$..UserId,exa_regex=({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)"""
...
"""exa_json_path=$.Attendees[0:].UPN,exa_regex=({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)"""
"""exa_json_path=$.ArtifactsShared[0].ArtifactSharedName,exa_field_name=object_name"""
"""exa_json_path=$.ArtifactsShared[0].ArtifactShareSessions[0].StartTimestamp,exa_field_name=start_time"""
"""exa_json_path=$.ArtifactsShared[0].ArtifactShareSessions[0].EndTimestamp,exa_field_name=end_time"""
...
"""\ssuser=(anonymous|SecurityComplianceAlerts|({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)|(Unknown|Sync|AirInvestigation|(\w+?_)?(\w+-)?\w+-\w+-\w+-\w+|({user}[\w\.\-\!\#\^\~]{1,40}\$?)))\s""",
""""ChatName":"({object_name}[^"]+)"""",
""""ItemName":"({object_name}[^"]+)"""",
""""Sender":"({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)"""",
""""Receivers":\[({email_recipients}"({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))[^\]]+?)\],"""",
...
""""MailboxPrimaryAddress":"({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)"""",
...
""""UserId":"({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)"""
