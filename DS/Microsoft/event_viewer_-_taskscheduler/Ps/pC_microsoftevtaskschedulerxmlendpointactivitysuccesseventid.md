...
```Java
{
Name = microsoft-evtaskscheduler-xml-endpoint-activity-success-eventid
  Product = Event Viewer - TaskScheduler
  Conditions = [ """<EventID""", """<Computer>""",  """<Provider Name =""", """Microsoft""", """<Channel>Microsoft-Windows-TaskScheduler""" ]
