...
```Java
{
Name = microsoft-windows-kv-scheduled-task-trigger-success-200
  Product = Event Viewer - TaskScheduler
  ParserVersion = "v1.0.0"
  Conditions = [ """eventid="200"""", """Microsoft-Windows-TaskScheduler""" ]
  Fields = ${WindowsParsersTemplates.windows-events-2.Fields}[
    """({event_name}Task Scheduler launched action)""",
  ]
