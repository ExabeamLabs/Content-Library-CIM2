...
```Java
{
Name = microsoft-sysmon-kv-endpoint-notification-success-255
  Vendor = Microsoft
  Product = Sysmon
  ParserVersion = "v1.0.0"
  TimeFormat = "yyyy-MM-dd'T'HH:mm:ss.SSSSSSSSSZ"
  Conditions = [ """Event_ID="255"""", """[Event.System""", """][Event.System.TimeCreated _SystemTime=""" ]
  Fields = [
    """Computer="({host}[^"]+)"""",
    ...
    """Event_ID="({event_code}[^"]+)"""",
    """Keywords="({result}[^"]+)"""",
    """Description:\s*({additional_info}[^"]+Last\serror:[^"\.]+)""",
