...
```Java
{
Name = microsoft-evsecurityrds-xml-endpoint-activity-success-eventid
  Product = Event Viewer - RemoteDesktopServices
  Conditions = [ """<EventID""", """<Computer>""", """<Provider Name ='Microsoft""", """<Channel>Microsoft-Windows-RemoteDesktopServices-RdpCoreTS""" ]
