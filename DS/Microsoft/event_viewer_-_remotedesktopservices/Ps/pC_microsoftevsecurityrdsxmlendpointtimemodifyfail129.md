...
```Java
{
Name = microsoft-evsecurityrds-xml-endpoint-time-modify-fail-129
  ParserVersion = v1.0.0
  Product = Event Viewer - RemoteDesktopServices
  Conditions = [ """<EventID>129</EventID>""" , """<Channel>Microsoft-Windows-RemoteDesktopServices-RdpCoreTS""" ]
