...
```Java
{
Name = microsoft-m365auditlogs-sk4-alert-trigger-accessgovernance
  ParserVersion = v1.0.0
  Vendor = Microsoft
  Product = M365 Audit Logs
  Conditions = [ """"category":"AccessGovernance"""", """"title":""", """"vendor":"Microsoft"""", """"provider":"Office 365 Security and Compliance"""" ]
  Fields = ${MicrosoftParserTemplates.json-microsoft-security-events.Fields}[
    """msg=Security Alert Detected by \[({alert_source}[^\]]+)"""
  ]
