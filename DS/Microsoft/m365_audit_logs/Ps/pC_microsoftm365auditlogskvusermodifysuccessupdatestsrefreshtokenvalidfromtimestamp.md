...
```Java
{
Name = microsoft-m365auditlogs-kv-user-modify-success-updatestsrefreshtokenvalidfromtimestamp
  ParserVersion = v1.0.0
  Product = M365 Audit Logs
  Conditions = [ """SESSID=""", """RESULTCODE=""", """WORKLOAD=""", """COMMAND=Update StsRefreshTokenValidFrom Timestamp.""", """OBJECT=""" ]
