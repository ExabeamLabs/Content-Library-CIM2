...
```Java
{
Name = microsoft-evazureadppdca-xml-user-password-reset-fail-30003
  Vendor = Microsoft
  Product = Event Viewer - AzureADPasswordProtection-DCAgent
  ParserVersion = "v1.0.0"
  Conditions = [ """<EventID>30003</EventID>""", """<Provider Name""","""'Microsoft-AzureADPasswordProtection-DCAgent'""" ]
