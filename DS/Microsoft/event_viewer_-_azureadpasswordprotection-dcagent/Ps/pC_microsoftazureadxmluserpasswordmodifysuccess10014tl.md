...
```Java
{
Name = "microsoft-azuread-xml-user-password-modify-success-10014-tl"
    ParserVersion = "v1.0.0"
    Vendor = "Microsoft"
    Product = "Event Viewer - AzureADPasswordProtection-DCAgent"
    TimeFormat = "yyyy-MM-dd'T'HH:mm:ss.SSSSSSSSSZ"
    Conditions = [
      "<eventid>10014</eventid>"
    ...
    Fields = [
      ...
      "(?i)<EventID>({event_code}10014)</EventID>"
      "(?i)({event_name}The changed password for the specified user was validated as compliant with the current Azure password policy)"
