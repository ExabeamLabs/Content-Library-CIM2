...
Name = microsoft-evsecurity-kv-endpoint-login-4769-4
  ...
  Fields = [
    ...
    """Failure Code(:|=)(\s|\\[rnt])*({result_code}.+?)(\s|\\[rnt]|;)*Transited Services(:|=)"""
    """Ticket Options(:|=)(\s|\\[rnt])*({ticket_options}[^;].+?)(\s|\\[nrt]|;)*Ticket Encryption Type(:|=)"""
    """Ticket Encryption Type(:|=)(\s|\\[rnt])*({ticket_encryption_type}.+?)(\s|\\[nrt]|;)*Failure Code(:|=)"""
