...
```Java
{
Name = microsoft-evsecurity-xml-ds-replication-stop-4933
  ParserVersion = v1.0.0
  Conditions = [ """Synchronization of a replica of an Active Directory naming context has ended""", """4933""" ]
  Fields = ${DLWindowsParsersTemplates.windows-events-1.Fields}[
    """({time}(?i)(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) \d{1,2} \d{1,2}:\d{1,2}:\d{1,2} 20\d{2})""",
# dest_dra is removed
    """\sSession ID:\s*({session_id}\d+)""",
    """({event_name}Synchronization of a replica of an Active Directory naming context has ended)""",
    """({event_code}4933)"""
  ]
