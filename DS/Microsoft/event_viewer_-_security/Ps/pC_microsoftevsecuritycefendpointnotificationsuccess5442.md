...
```Java
{
Name = microsoft-evsecurity-cef-endpoint-notification-success-5442
    ParserVersion = v1.0.0
    Conditions = [ """CEF:""", """|Microsoft-Windows-Security-Auditing:5442|""" ]
    Fields = ${WindowsParsersTemplates.windows-events-3.Fields} [
      ...
      """\sahost=({host}[^\s]+)""",
      """({event_name}The following provider was present when the Windows Filtering Platform Base Filtering Engine started)""",
      """({event_code}5442)""",
