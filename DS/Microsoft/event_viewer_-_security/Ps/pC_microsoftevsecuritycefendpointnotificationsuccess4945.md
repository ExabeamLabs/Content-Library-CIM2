...
```Java
{
Name = microsoft-evsecurity-cef-endpoint-notification-success-4945
    ParserVersion = v1.0.0
    Conditions = [ """CEF:""", """|Microsoft-Windows-Security-Auditing:4945|""", """A rule was listed when the Windows Firewall started""" ]
