...
"""exa_json_path=$.Properties.LayerName,exa_field_name=layer_name"""
"""exa_json_path=$.Properties.Protocol,exa_field_name=ms_protocol_num"""
"""exa_json_path=$.Properties.ProcessID,exa_field_name=process_id"""
"""exa_json_path=$.Properties.Application,exa_regex=({process_path}({process_dir}[^"]+)[\\\/]({process_name}[^"]+))"""
"""exa_json_path=$.Properties.Direction,exa_field_name=direction"""
"""exa_json_path=$.Properties.DestAddress,exa_regex=({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))"""
"""exa_json_path=$.Properties.DestPort,exa_field_name=dest_port"""
"""exa_json_path=$.Properties.SourceAddress,exa_regex=({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))"""
"""exa_json_path=$.Properties.SourcePort,exa_field_name=src_port"""
]
