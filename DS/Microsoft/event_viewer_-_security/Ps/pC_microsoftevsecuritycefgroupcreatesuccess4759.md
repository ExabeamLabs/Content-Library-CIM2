...
```Java
{
Name = microsoft-evsecurity-cef-group-create-success-4759
    ParserVersion = v1.0.0
    Conditions = [ """CEF:""", """|Microsoft-Windows-Security-Auditing:4759|""", """A security-disabled universal group was created""" ]
    Fields = ${WindowsParsersTemplates.windows-events-3.Fields} [
      ...
      """\sahost=({host}[^\s]+)""",
      """({event_name}A security-disabled universal group was created)""",
      """({event_code}4759)"""
