...
Name = "microsoft-evsecurity-kv-endpoint-login-success-4624-3"
  ...
  TimeFormat = ["yyyy-MM-dd'T'HH:mm:ss", "yyyy-MM-dd HH:mm:ss", "epoch", "epoch_sec", "MM/dd/yyyy hh:mm:ss a", "MMM dd HH:mm:ss yyyy"]
  Conditions = [
  ...
  Fields = [
    ...
    """exa_json_path=$.Message,exa_regex=Logon ID(:|=)(\\[nrt]|\s)*({login_id}[^\s\\;]+)(\\[nrt]|\s)*"""
