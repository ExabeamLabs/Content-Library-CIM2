...
```Java
{
Name = microsoft-evsecurity-kv-ds-object-create-success-5137-1
...
ad-audit-ds-access = {
  ...
  Fields = [
    ...
    """CLIENT_IP_ADDRESS\s*=\s*(null|-|({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?)"""
  ]
