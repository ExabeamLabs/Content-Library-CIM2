...
```Java
{
Name = microsoft-evsecurity-xml-endpoint-notification-5033
  Product = Event Viewer - Security
  ParserVersion = v1.0.0
  Conditions = [ """The Windows Firewall Driver started successfully""", """<EventID>5033<""","""<Channel>Security</Channel>""" ]
