...
TimeFormat = ["epoch_sec", "yyyy-MM-dd'T'HH:mm:ss.SSSZ", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ", "MM/dd/yyyy hh:mm:ss a", "MMM dd HH:mm:ss yyyy"]
Conditions = [
...
"""Target Account.+?Account Name:\s*[\\trn]*({dest_user}[^:].+?)\s*(\\n|\\r\s\\t)*?[rnt\\]*?\s*Account Domain:\s*"""
]
