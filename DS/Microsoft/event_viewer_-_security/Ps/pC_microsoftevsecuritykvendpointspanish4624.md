...
Name = microsoft-evsecurity-kv-endpoint-spanish-4624
  ...
  Fields = [
   ...
   """Nombre de estación de trabajo\s*(-|[A-Fa-f:\d.]+|({src_host}[^\s;]+))[\s;]*Dirección de red de origen:\s*({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))\s*Puerto de origen:\s*({src_port}\d+)""",
