...
Name = microsoft-evsecurity-csv-endpoint-login-success-4770
  ...
  Fields = [
    ...
    """クライアント アドレス:\s+(::[\w]+:)?(({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))|::1)(:({src_port}\d+))?"""
    """クライアント アドレス:\s+(::[\w]+:)?({dest_ip}(?!::1)((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?"""
  ]
