...
Name = microsoft-evsecurity-json-endpoint-login-fail-4625-2
  ...
  Fields = ${WindowsParsersTemplates.json-windows-events-2-aa.Fields}[
    ...
    """TargetUserName\\?"+:\\?"+(?:-|(?i)(system|anonymous logon|LOCAL SERVICE|LOCAL SYSTEM)|((({user}[\w\.\-\!\#\^\~]{1,40}\$?)(?:@({domain}[^\\]+))?)|({user_upn}[^@\s]+?@[^\s\.]+?\.[^\s\\]+?)))\\?"""",
  ...
  DupFields = [ "host->dest_host", "result_code->failure_code", "user->dest_user", "domain->dest_domain", "user_sid->dest_user_sid" ]
