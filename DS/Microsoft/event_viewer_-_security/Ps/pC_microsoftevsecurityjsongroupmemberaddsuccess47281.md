...
```Java
{
Name = "microsoft-evsecurity-json-group-member-add-success-4728-1"
  Vendor = "Microsoft"
  Product = "Event Viewer - Security"
  TimeFormat = "yyyy-MM-dd HH:mm:ss"
  Conditions = [ """"SourceName":"Microsoft-Windows-Security-Auditing"""", """"EventID":4728""", """"Category":"Security Group Management"""" ]
  Fields = [
