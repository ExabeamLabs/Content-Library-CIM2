...
```Java
{
Name = microsoft-evsecurity-json-scheduled-task-modify-4702-1
  ParserVersion = v1.0.0
  Vendor = Microsoft
  Product = Event Viewer - Security
  ExtractionType = json
  TimeFormat = ["yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSSZ" ]
  Conditions = [ """"EventID":"4702"""", """Microsoft-Windows-Security-Auditing""", """"Channel":"Security"""" ]
  Fields = [
    """exa_json_path=$..SystemTime,exa_field_name=time""",
    """exa_json_path=$..Provider.Name,exa_field_name=provider_name""",
    """exa_json_path=$..Provider.Guid,exa_field_name=process_guid""",
    """exa_json_path=$..EventID,exa_field_name=event_code""",
    """exa_json_path=$..System..Opcode,exa_field_name=opcode""",
    """exa_json_path=$..System..Keywords,exa_field_name=result"""
    """exa_json_path=$..System..Channel,exa_field_name=channel""",
