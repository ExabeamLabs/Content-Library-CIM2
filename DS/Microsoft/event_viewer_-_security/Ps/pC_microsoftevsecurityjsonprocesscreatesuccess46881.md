...
"""A new process has been created"""
  ...
  Fields = [
      ...
      """exa_json_path=$.Properties.NewProcessId,exa_field_name=process_guid"""
      """exa_json_path=$.Properties.NewProcessName,exa_regex=({process_path}({process_dir}[^"]+[\\\/]+)?({process_name}[^"\\\/]+))"""
      ...
      """exa_json_path=$.Properties.ComputerName,exa_field_name=host"""
      """exa_json_path=$.Properties.ParentProcessName,exa_regex=({parent_process_path}({parent_process_dir}[^"]+[\\\/]+)?({parent_process_name}[^"\\\/]+))"""
  ]
