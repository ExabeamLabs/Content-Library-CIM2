...
```Java
{
Name = microsoft-evsecurity-cef-endpoint-notification-success-4944
    ParserVersion = v1.0.0
    Conditions = [ """CEF:""", """|Microsoft-Windows-Security-Auditing:4944|""", """The following policy was active when the Windows Firewall started""" ]
    Fields = ${WindowsParsersTemplates.windows-events-3.Fields} [
      ...
      """\sahost=({host}[^\s]+)""",
      """({event_name}The following policy was active when the Windows Firewall started)""",
      """({event_code}4944)"""
   ]
