...
```Java
{
Name = microsoft-evsecurity-cef-endpoint-notification-success-5440
    ParserVersion = v1.0.0
    Conditions = [ """CEF:""", """|Microsoft-Windows-Security-Auditing:5440|""", ]
    Fields = ${WindowsParsersTemplates.windows-events-3.Fields} [
      ...
      """\sahost=({host}[^\s]+)""",
      """({event_name}Filtering Platform Base Filtering Engine started)""",
      """({event_code}5440)"""
   ]
