...
```Java
{
Name = microsoft-defenderep-json-alert-trigger-success-bruteforcesecurityalert
  Conditions = [ """"category":""", """"BruteForceSecurityAlert"""", """"createdDateTime":""", """"eventDateTime":""", """"azureTenantId":""", """"status":""", """"title":""" ]
...
json-atp-alert = {
  ...
  Fields = [
    ...
    """exa_regex="userStates":\s*[^\]]+?"userPrincipalName":\s*"(({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)|({full_name}[^"]+))""""
