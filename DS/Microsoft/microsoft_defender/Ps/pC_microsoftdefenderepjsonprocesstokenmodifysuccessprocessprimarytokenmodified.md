...
```Java
{
Name = "microsoft-defenderep-json-process-token-modify-success-processprimarytokenmodified"
  ExtractionType = json
  ParserVersion = "v1.0.0"
  Product = "Microsoft Defender"
  Conditions = [  """DeviceEvents"""", """"ActionType":"ProcessPrimaryTokenModified"""" ]
  Fields = ${MicrosoftParserTemplates.json-defender-atp.Fields} [
    """"tokenChangeDescription\\*":\\*"({event_name}[^"]+)\\*""""
  ]
