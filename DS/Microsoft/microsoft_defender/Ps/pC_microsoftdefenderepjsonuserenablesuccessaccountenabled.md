...
```Java
{
Name = "microsoft-defenderep-json-user-enable-success-accountenabled"
  Vendor = Microsoft
  Product = "Microsoft Defender"
  Conditions = [ """"category":""", """"AdvancedHunting-IdentityDirectoryEvents"""", """"ActionType":""", """"Account enabled"""" ]
  ExtractionType = json
