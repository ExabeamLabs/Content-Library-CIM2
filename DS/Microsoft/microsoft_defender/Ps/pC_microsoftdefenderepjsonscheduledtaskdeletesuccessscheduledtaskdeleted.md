...
```Java
{
Name = "microsoft-defenderep-json-scheduled-task-delete-success-scheduledtaskdeleted"
  ExtractionType = json
  Conditions = [  """DeviceEvents"""", """"ActionType":"ScheduledTaskDeleted"""" ]
  Fields = ${MicrosoftParserTemplates.json-defender-atp.Fields} [
  """exa_json_path=$..InitiatingProcessAccountName,exa_regex=(SYSTEM|NETWORK SERVICE|LOCAL SERVICE|Système|system|local service|-|({src_user}({user}[\w\.\-\!\#\^\~]{1,40}\$?))|({full_name}[^",]+))"""
