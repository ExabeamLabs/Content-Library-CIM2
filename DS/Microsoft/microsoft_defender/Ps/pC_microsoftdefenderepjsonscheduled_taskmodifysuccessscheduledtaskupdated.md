...
```Java
{
Name = "microsoft-defenderep-json-scheduled_task-modify-success-scheduledtaskupdated"
  ExtractionType = json
  Conditions = [  """DeviceEvents"""", """"ActionType":"ScheduledTaskUpdated"""" ]
  Fields = ${MicrosoftParserTemplates.json-defender-atp.Fields} [
    """exa_regex="TaskName\\?":\\?"({task_name}[^"\\]+)""",
