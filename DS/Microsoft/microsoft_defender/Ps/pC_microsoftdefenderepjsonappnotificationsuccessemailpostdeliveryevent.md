...
```Java
{
Name = "microsoft-defenderep-json-app-notification-success-emailpostdeliveryevent"
  Vendor = Microsoft
  Product = "Microsoft Defender"
  Conditions = [ """"category":""", """"AdvancedHunting-EmailPostDeliveryEvents"""", """"ActionType":""", """"DeliveryLocation":""" ]
  ExtractionType = json
  ...
  Fields = [
    ...
    """exa_json_path=$..ThreatTypes,exa_field_name=event_name""",
