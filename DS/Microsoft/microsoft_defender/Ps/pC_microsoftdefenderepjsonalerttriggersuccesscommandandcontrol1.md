...
```Java
{
Name = microsoft-defenderep-json-alert-trigger-success-commandandcontrol-1
     ExtractionType = json
     Conditions = [ """"category":""", """"CommandAndControl"""", """"title":""", """"incidentId":""",  """"detectionSource":""", """"threatFamilyName":""", """"serviceSource":""", """"MicrosoftDefenderForEndpoint"""" ]
