...
```Java
{
Name = microsoft-defenderep-json-alert-trigger-success-lateralmovement-2
     ExtractionType = json
     Conditions = [ """"category":""", """"LateralMovement"""", """"title":""", """"incidentId":""",  """"threatFamilyName":""", """"detectionSource":""" ]
