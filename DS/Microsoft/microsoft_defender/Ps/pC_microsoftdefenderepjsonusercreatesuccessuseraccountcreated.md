...
```Java
{
Name = "microsoft-defenderep-json-user-create-success-useraccountcreated"
  Vendor = Microsoft
  Product = "Microsoft Defender"
  Conditions = [ """"category":""", """"AdvancedHunting-IdentityDirectoryEvents"""", """"ActionType":""", """"User Account Created"""" ]
  ExtractionType = json
  ...
  Fields = [
    ...
    """exa_json_path=$..AccountUpn,exa_regex=(({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)|({user}[\w\.\-\!\#\^\~]{1,40}\$?)),exa_match_expr=!Contains(tolower($..AccountUpn), "null")""",
