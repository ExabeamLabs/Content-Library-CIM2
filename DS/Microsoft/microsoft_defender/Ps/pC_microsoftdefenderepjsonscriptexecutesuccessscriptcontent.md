...
```Java
{
Name = "microsoft-defenderep-json-script-execute-success-scriptcontent"
  ExtractionType = json
  Conditions = [  """DeviceEvents"""", """"ActionType":"ScriptContent"""" ]
  Fields = ${MicrosoftParserTemplates.json-defender-atp.Fields} [
    """exa_regex="ScriptContent\\?":\\?"({script_content}.+?)"\}",""",
  ]
