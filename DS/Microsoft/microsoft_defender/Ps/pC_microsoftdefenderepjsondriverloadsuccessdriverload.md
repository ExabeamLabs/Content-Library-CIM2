...
```Java
{
Name = "microsoft-defenderep-json-driver-load-success-driverload"
  ExtractionType = json
  Conditions = [ """DeviceEvents"""", """"ActionType":"DriverLoad"""" ]
  Fields = ${MicrosoftParserTemplates.json-defender-atp.Fields} [
    """exa_regex="ImageName\\":\\"({file_path}({file_dir}[^"]*[\\\/]+)({file_name}[^\\\/"]+\.({file_ext}\w+)))\\?""""
  ]
