...
```Java
{
Name = "microsoft-defenderep-json-group-member-add-success-useraccountadded"
  Conditions = [  """DeviceEvents"""", """"ActionType":"UserAccountAddedToLocalGroup"""" ]
  ParserVersion = "v1.0.0"
  Fields = ${MicrosoftParserTemplates.json-defender-atp.Fields} [
    """"GroupName\\*":\\*"({group_name}[^"]+?)\\*"""",
    """"GroupDomainName\\*":\\*"({group_domain}[^"]+?)\\*""""
    """"AccountSid":\s*"({dest_user_sid}[^"]+)""""
  ]   
