...
```Java
{
Name = "microsoft-defenderep-sk4-alert-trigger-callblocked"
  ParserVersion = "v1.0.0"
  Product = "Microsoft Defender"
  Conditions = ["""requestClientApplication=""", """AdvancedHunting-DeviceEvents""","""ExploitGuardWin32SystemCallBlocked"""]
