...
```Java
{
Name = microsoft-defenderep-cef-scheduled-task-create-scheduledtaskcreated
  ParserVersion = "v1.0.0"
  Product = Microsoft Defender
  Conditions = ["""requestClientApplication=""", """AdvancedHunting-DeviceEvents""","""ScheduledTaskCreated"""]
