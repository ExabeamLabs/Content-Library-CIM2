...
```Java
{
Name = microsoft-defenderep-xml-endpoint-activity-success-eventid
  Product = Microsoft Defender
  Conditions = [ """<EventID""", """<Computer>""", """<Provider Name =""", """Microsoft""", """<Channel>Microsoft-Windows-Windows Defender""" ]
