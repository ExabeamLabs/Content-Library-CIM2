...
```Java
{
Name = microsoft-defender365-json-alert-trigger-success-initialaccess
     Product = Microsoft Defender
     ExtractionType = json
     Conditions = [ """"productName":"Microsoft Defender for Office 365"""", """"category":""", """"InitialAccess"""", """"title":""", """"incidentId":""",  """"detectionSource":""", """"serviceSource":""" ]
