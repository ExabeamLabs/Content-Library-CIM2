...
```Java
{
Name = "microsoft-defenderep-str-app-notification-removedhistory"
  ...
  Fields = ${WindowsParsersTemplates.windows-defender-1.Fields}[
    ...
    """({event_name}Windows Defender Antivirus has removed history of malware and other potentially unwanted software)"""
  ]
