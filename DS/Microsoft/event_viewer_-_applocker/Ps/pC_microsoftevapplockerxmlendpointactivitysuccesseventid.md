...
```Java
{
Name = microsoft-evapplocker-xml-endpoint-activity-success-eventid
  Product = Event Viewer - Applocker
  Conditions = [ """<EventID""", """<Computer>""",  """<Provider Name =""", """Microsoft""", """<Channel>Microsoft-Windows-AppLocker""" ]
