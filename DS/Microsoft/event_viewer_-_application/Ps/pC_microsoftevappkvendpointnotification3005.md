...
Name = microsoft-evapp-kv-endpoint-notification-3005
  ...
  ExtractionType = json
  TimeFormat = ["MM/dd/yyyy hh:mm:ss a", "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ","yyyy-MM-dd'T'HH:mm:ss.SSSSSSSSSZ"]
  ...
  Fields = [
    ...
    """\s({host}[\w.-]+)\s+Web Event\s+Event code:\s*3005""",
...
# request_url is removed
    ...
    """exa_regex=\s({host}[\w.-]+)\s+Web Event\s+Event code:\s*3005""",
