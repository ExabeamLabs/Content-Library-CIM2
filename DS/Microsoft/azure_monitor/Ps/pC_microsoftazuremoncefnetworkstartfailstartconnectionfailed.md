...
```Java
{
Name = microsoft-azuremon-cef-network-start-fail-startconnectionfailed
  ParserVersion = v1.0.0
  Conditions= [ """destinationServiceName =Azure""", """"category":"AllLogs"""", """"collection":"Connection"""", """"operationName":"StartConnectionFailed"""" ]
