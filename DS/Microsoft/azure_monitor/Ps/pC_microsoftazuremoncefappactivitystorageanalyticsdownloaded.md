...
```Java
{
Name = microsoft-azuremon-cef-app-activity-storageanalyticsdownloaded
  ParserVersion = "v1.0.0"
  Product = Azure Monitor
  Conditions= [ """CEF:""", """destinationServiceName =Azure""", """dproc=Storage Analytics""", """|resource-downloaded|""" ]
