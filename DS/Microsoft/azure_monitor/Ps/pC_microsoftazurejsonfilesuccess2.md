...
azure-classicblob-json = {
    ...
    Fields = [
      ...
      """exa_json_path=$.properties.accountName,exa_field_name=storage_account""", 
      """exa_json_path=$.properties.userAgentHeader,exa_field_name=user_agent""", 
      """exa_json_path=$.properties.lastModifiedTime,exa_field_name=file_modify_time""", 
      """exa_json_path=$.properties.requestBodySize,exa_field_name=bytes_in""", 
