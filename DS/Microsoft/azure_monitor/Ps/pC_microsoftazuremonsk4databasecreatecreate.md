...
```Java
{
Name = microsoft-azuremon-sk4-database-create-create
  ParserVersion = v1.0.0
  Conditions=[ """"resourceId":""", """"category":""", """"DataPlaneRequests"""", """MICROSOFT.DOCUMENTDB""", """"operationName":""", """"Create"""" ]
