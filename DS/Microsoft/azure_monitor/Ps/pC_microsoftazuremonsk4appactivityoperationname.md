...
Name = microsoft-azuremon-sk4-app-activity-operationname
  ...
  Conditions= [ """CEF:""", """destinationServiceName =Azure""", """"OperationName":"""", """"Category":"""", """cat=audit """ ]
...
# azure_event_hub_name is removed
    ...
    """"InitiatingProcessAccountName":"(system|({user}[\w\.\-\!\#\^\~]{1,40}\$?))"""",
    """"InitiatingProcessAccountDomain":"(nt authority|({domain}[^"]+))"""",
    """"InitiatingProcessAccountUpn":"({email_address}([A-Za-z0-9]+[!#$%&'+\/=?^_`~.\-])*[A-Za-z0-9]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))""""
