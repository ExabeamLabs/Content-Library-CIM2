...
Name = microsoft-azuremon-sk4-app-notification-timegrain
  ...
  Conditions = [ """"resourceId":""", """"metricName":""", """"timeGrain":""", """"average":""" ]
  Fields = ${LMSMSParsersTemplates.cef-microsoft-app-activity1.Fields}[
    ...
    """exa_regex="time":"({time}\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\d.\d+Z)"""
    """exa_regex="TimeGenerated":"({time}\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\dZ)""",
