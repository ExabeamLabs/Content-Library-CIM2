...
```Java
{
Name = microsoft-azuremon-mix-network-start-collection
  ParserVersion = v1.0.0
  Conditions= [ """destinationServiceName =Azure""", """"category":"AllLogs"""", """"collection":"Connection"""", """"operationName":"ConnectionStarted"""", """"message":"Connection started"""" ]
