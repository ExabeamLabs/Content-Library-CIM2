...
```Java
{
Name = microsoft-evsystem-json-endpoint-authentication-fail-5723
  ParserVersion = v1.0.0
  Vendor = Microsoft
  Product = Event Viewer - System
  ExtractionType = json
  TimeFormat = ["yyyy-MM-dd HH:mm:ss Z"]
  Conditions = [ """"EventID":5723""", """"ProviderName":"NETLOGON"""", """failed because the security database does not contain""" ]
  Fields = [
