...
```Java
{
Name = "microsoft-evntlm-xml-alert-trigger-success-4014"
  Vendor = "Microsoft"
  Product = "Event Viewer - NTLM"
  Conditions = [ """<EventID>4014<""", """<Provider Name =""", """<Channel>Microsoft-Windows-NTLM/Operational</Channel>""" , """Attempt to get credential key by call package blocked by Credential Guard"""]
