...
```Java
{
Name = microsoft-evntlm-xml-endpoint-authentication-success-8006
  Vendor = Microsoft
  Product = Event Viewer - NTLM
  ParserVersion = "v1.0.0"
  TimeFormat = ["yyyy-MM-dd'T'HH:mm:ss" , "yyyy-MM-dd'T'HH:mm:ss.SSSSSSSZ"]
  Conditions = [ """<EventID>8006</EventID>""", """<Provider Name =""", """<Channel>Microsoft-Windows-NTLM/Operational</Channel>""" ]
  Fields = [
