...
```Java
{
Name = microsoft-evadfs-kv-app-authentication-success-1202
...
Fields = ${WindowsParsersTemplates.windows-events-6.Fields}[
  ...
  """(<|&lt;)UserId(&gt;|>)(N\/A|({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@[^\]\s"\\,\|]+\.[^\]\s"\\,\|]+)|(({domain}[^\\&]+)\\+)?({user}[\w\.\-\!\#\^\~]{1,40}\$?))(<|&lt;)\/UserId(&gt;|>)""",
	"""ComputerName =({host}[\w\-.]+)""",
	"""({event_name}The Federation Service validated a new credential)""",
]
