...
```Java
{
Name = "microsoft-defenderep-sk4-alert-trigger-theftaudited"
  ParserVersion = "v1.0.0"
  Product = "Microsoft Defender for Endpoint"
  Conditions = ["""requestClientApplication=""", """AdvancedHunting-DeviceEvents""","""AsrLsassCredentialTheftAudited"""]
