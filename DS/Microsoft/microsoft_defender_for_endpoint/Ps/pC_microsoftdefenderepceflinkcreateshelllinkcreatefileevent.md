...
```Java
{
Name = microsoft-defenderep-cef-link-create-shelllinkcreatefileevent
  ParserVersion = v1.0.0
  Product = Microsoft Defender for Endpoint
  Conditions = ["""requestClientApplication=""", """AdvancedHunting-DeviceEvents""","""ShellLinkCreateFileEvent"""]
