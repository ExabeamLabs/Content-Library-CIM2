...
```Java
{
Name = microsoft-defenderep-cef-process-thread-create-remotethreadapicall
  ParserVersion = "v1.0.0" 
  Product = Microsoft Defender for Endpoint
  Conditions = ["""requestClientApplication=""", """AdvancedHunting-DeviceEvents""","""CreateRemoteThreadApiCall"""]
