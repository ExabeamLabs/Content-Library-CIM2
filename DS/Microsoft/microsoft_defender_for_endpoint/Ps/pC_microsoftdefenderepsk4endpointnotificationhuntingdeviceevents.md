...
```Java
{
Name = microsoft-defenderep-sk4-endpoint-notification-huntingdeviceevents
  ParserVersion = "v1.0.0"
  Product = "Microsoft Defender for Endpoint"
  Conditions = ["""requestClientApplication=""", """AdvancedHunting-DeviceEvents""","""DeviceBootAttestationInfo"""]
