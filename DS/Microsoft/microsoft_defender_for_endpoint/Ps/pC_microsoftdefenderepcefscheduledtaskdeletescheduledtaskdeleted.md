...
```Java
{
Name = microsoft-defenderep-cef-scheduled-task-delete-scheduledtaskdeleted
  ParserVersion = "v1.0.0"
  Product = Microsoft Defender for Endpoint
  Conditions = ["""requestClientApplication=""", """AdvancedHunting-DeviceEvents""","""ScheduledTaskDeleted"""]
