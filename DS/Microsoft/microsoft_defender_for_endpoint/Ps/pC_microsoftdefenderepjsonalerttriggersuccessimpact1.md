...
```Java
{
Name = microsoft-defenderep-json-alert-trigger-success-impact-1
     ExtractionType = json
     Conditions = [ """"category":""", """"Impact"""", """"title":""", """"incidentId":""",  """"detectionSource":""", """"threatFamilyName":""", """"serviceSource":""", """"MicrosoftDefenderForEndpoint"""" ]
