...
```Java
{
Name = microsoft-defenderep-json-alert-trigger-success-ransomware
     Conditions = [ """"category":""", """"Ransomware"""", """"title":""", """"incidentId":""",  """"detectionSource":""", """"threatFamilyName":""", """"serviceSource":""", """"MicrosoftDefenderForEndpoint"""" ]
