...
```Java
{
Name = "microsoft-defenderep-cef-process-token-modify-processprimarytokenmodified"
  ParserVersion = "v1.0.0"
  Product = "Microsoft Defender for Endpoint"
  Conditions = [ """requestClientApplication=""", """AdvancedHunting-DeviceEvents""","""ProcessPrimaryTokenModified""" ]
