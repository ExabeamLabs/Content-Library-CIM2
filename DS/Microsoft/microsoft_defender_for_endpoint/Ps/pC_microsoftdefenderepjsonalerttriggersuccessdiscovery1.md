...
```Java
{
Name = microsoft-defenderep-json-alert-trigger-success-discovery-1
     Conditions = [ """"category":""", """"Discovery"""", """"title":""", """"incidentId":""",  """"detectionSource":""", """"threatFamilyName":""", """"serviceSource":""", """"MicrosoftDefenderForEndpoint"""" ]
