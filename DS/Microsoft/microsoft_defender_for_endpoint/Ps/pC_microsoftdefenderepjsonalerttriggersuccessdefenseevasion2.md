...
```Java
{
Name = microsoft-defenderep-json-alert-trigger-success-defenseevasion-2
     Conditions = [ """"category":""", """"DefenseEvasion"""", """"title":""", """"incidentId":""",  """"detectionSource":""", """"threatFamilyName":""", """"serviceSource":""", """"MicrosoftDefenderForEndpoint"""" ]
