...
```Java
{
Name = microsoft-defenderep-cef-endpoint-notification-deviceconnected
  Product = Microsoft Defender for Endpoint
  ParserVersion = "v1.0.0"
  Conditions = ["""requestClientApplication=""", """AdvancedHunting-DeviceEvents""","""PnpDeviceConnected"""]
