...
```Java
{
Name = microsoft-defenderep-cef-process-memory-allocate-advancedhunting-1
    ParserVersion = v1.0.0
    Vendor = Microsoft
    Product = Microsoft Defender for Endpoint
    Conditions = ["""requestClientApplication=""", """AdvancedHunting-DeviceEvents""","""NtAllocateVirtualMemoryRemoteApiCall"""]
