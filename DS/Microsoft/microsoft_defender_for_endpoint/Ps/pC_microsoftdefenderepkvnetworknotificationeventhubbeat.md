...
```Java
{
Name = microsoft-defenderep-kv-network-notification-eventhubbeat
  ParserVersion = "v1.0.0"
  Conditions = ["""|beatname=eventhubbeat|""", """|device_type=eventhubbeat|""", """|subject=AdvancedHunting-DeviceNetworkInfo|""", """vmid=""", """@timestamp""", """@metadata"""]
