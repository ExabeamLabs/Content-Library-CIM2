...
```Java
{
Name = microsoft-defenderep-json-alert-trigger-success-suspiciousactivity-1
     Conditions = [ """"category":""", """"SuspiciousActivity"""", """"title":""", """"incidentId":""",  """"detectionSource":""", """"threatFamilyName":""", """"serviceSource":""", """"MicrosoftDefenderForEndpoint"""" ]
