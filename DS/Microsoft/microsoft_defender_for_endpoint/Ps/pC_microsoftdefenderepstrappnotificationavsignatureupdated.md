...
```Java
{
Name = "microsoft-defenderep-str-app-notification-avsignatureupdated"
  Product = Microsoft Defender for Endpoint
  Conditions = [ 
    """Microsoft-Windows-Windows Defender/Operational"""
    """Windows Defender Antivirus signature version has been updated"""
  ]
  Fields = ${WindowsParsersTemplates.windows-defender-1.Fields}[
    """({event_name}Windows Defender Antivirus signature version has been updated)"""
  ]
