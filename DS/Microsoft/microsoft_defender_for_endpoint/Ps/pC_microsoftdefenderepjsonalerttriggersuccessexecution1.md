...
```Java
{
Name = microsoft-defenderep-json-alert-trigger-success-execution-1
     Conditions = [ """"category":""", """"Execution"""", """"title":""", """"incidentId":""",  """"detectionSource":""", """"threatFamilyName":""", """"serviceSource":""", """"MicrosoftDefenderForEndpoint"""" ]
