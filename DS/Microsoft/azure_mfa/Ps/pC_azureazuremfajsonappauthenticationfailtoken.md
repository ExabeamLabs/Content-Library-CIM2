...
```Java
{
Name = azure-azuremfa-json-app-authentication-fail-token
  ParserVersion = "v1.0.0"
  Conditions = [ """"additionalDetails":"Expected part of the token lifecycle - either an admin or a user revoked the tokens for this user""", """"resourceId":""", """"failureReason":""", """"userDisplayName":""" ]
