...
```Java
{
Name = azure-azuremfa-json-app-login-success-mfarequirementsatisfied
  ParserVersion = "v1.0.0"
  Conditions = [ """"additionalDetails":"MFA requirement satisfied by claim in the token""", """"resourceId":""" ]
