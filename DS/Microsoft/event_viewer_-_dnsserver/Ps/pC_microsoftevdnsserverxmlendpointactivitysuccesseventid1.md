...
```Java
{
Name = microsoft-evdnsserver-xml-endpoint-activity-success-eventid-1
  Product = Event Viewer - DNSServer
  Conditions = [ """<EventID""", """<Computer>""",  """<Provider Name =""", """Microsoft-Windows-DNS-Server-Service""", """Microsoft""", """<Channel>DNS Server""" ]
