...
```Java
{
Name = microsoft-evdnsserver-xml-endpoint-activity-success-eventid
  Product = Event Viewer - DNSServer
  Conditions = [ """<EventID""", """<Computer>""", """<Provider Name ='Microsoft""", """<Channel>Microsoft-Windows-DNSServer""" ]
