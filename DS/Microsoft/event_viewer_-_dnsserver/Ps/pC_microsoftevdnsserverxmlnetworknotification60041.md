...
```Java
{
Name = microsoft-evdnsserver-xml-network-notification-6004-1
  Product = Event Viewer - DNSServer
  Conditions = [ """<EventID>6004<""", """<Computer>""", """<Provider Name =""", """Microsoft-Windows-DNS-Server-Service""", """<Channel>DNS Server</Channel>""", """DNS_EVENT_BAD_ZONE_TRANSFER_REQUEST""" ]
