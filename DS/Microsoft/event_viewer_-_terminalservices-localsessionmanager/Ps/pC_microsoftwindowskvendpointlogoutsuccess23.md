...
```Java
{
Name = microsoft-windows-kv-endpoint-logout-success-23
  Product = Event Viewer - TerminalServices-LocalSessionManager
  ParserVersion = "v1.0.0"
  Conditions = [ """eventid="23"""", """Microsoft-Windows-TerminalServices-LocalSessionManager""" ]
  Fields = ${WindowsParsersTemplates.windows-events-2.Fields}[
    """({event_name}Remote Desktop Services: Session logoff succeeded)""",
