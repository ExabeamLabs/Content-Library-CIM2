...
```Java
{
Name = microsoft-windows-kv-endpoint-notification-success-41
  Product = Event Viewer - TerminalServices-LocalSessionManager
  ParserVersion = "v1.0.0"
  Conditions = [ """eventid="41"""", """Microsoft-Windows-TerminalServices-LocalSessionManager""" ]
  Fields = ${WindowsParsersTemplates.windows-events-2.Fields}[
    ...
    """({event_name}Begin session arbitration)""",
