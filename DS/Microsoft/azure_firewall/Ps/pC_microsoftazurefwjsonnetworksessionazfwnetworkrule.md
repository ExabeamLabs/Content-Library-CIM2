...
```Java
{
Name = microsoft-azurefw-json-network-session-azfwnetworkrule
     ParserVersion = v1.0.0
     Conditions = [ """"category":""", """"AZFWNetworkRule"""", """Action":""", """"Rule":""" ]
...
Fields = [
  ...
  """"Protocol":\s*"({protocol}[^"]+)""""
  """"Rule":\s*"({rule}[^"]+)""""
  """"SourceIp":\s*"({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))""""
  """"DestinationIp":\s*"({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))""""
