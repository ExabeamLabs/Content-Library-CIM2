...
""",STOREDRIVER,""" 
  ...
  Fields = [
    ...
    """,\s*(?:'|")?(|MicrosoftExchange.*?|({orig_user}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({src_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))(?:'|")?)\s*,(?:(?:\s*'+[^']*'+)\s*,|(?:\s*"+[^"]*"+)\s*,|[^",]+?,|\s*,){2}Originating,""",
    """,\s*(?:'|")?(|MicrosoftExchange.*?|({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({src_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))(?:'|")?)\s*,(?:(?:\s*'+[^']*'+)\s*,|(?:\s*"+[^"]*"+)\s*,|[^",]+?,|\s*,){2}Originating,""",
    """,\s*(?:'|")?(?:<>|({return_path}[^,]+?))(?:'|")?\s*,(?:(?:\s*'+[^']*'+)\s*,|(?:\s*"+[^"]*"+)\s*,|[^",]+?,|\s*,)Originating,""",
    """,\s*(?:'|")?(([^,]+Recipients_cn\=)?({email_recipients}[^,]+?))\s*(?:'|")?,(?:(?:\s*'(?:[^']|'')+')\s*,|(?:\s*"(?:[^"]|"")+")\s*,|[^",]+?,|\s*,){9}Originating,""",
    """,\s*(?:'|")?([^,]+Recipients_cn\=)?({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))\s*(?:'|")?,(?:(?:\s*'(?:[^']|'')+')\s*,|(?:\s*"(?:[^"]|"")+")\s*,|[^",]+?,|\s*,){9}Originating,""",
