...
Name = microsoft-mssql-json-app-login-fail-loginfailedforuser-1
  ...
  Fields = [
    ...
    """exa_json_path=$.winlog.computer_name,exa_field_name=dest_host""",
    """exa_json_path=$.winlog.event_data.param3,exa_regex=\[CLIENT:\s*({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))""",
