...
|:----:| ---- | ---- | ---- |
| [Compromised Credentials](../../../UseCases/uc_compromised_credentials.md) |  network-alert<br> ↳[ironnet-id-json-alert-trigger-success-irondefense](Ps/pC_ironnetidjsonalerttriggersuccessirondefense.md)<br> | T1027.005 - Obfuscated Files or Information: Indicator Removal from Tools<br>T1190 - Exploit Public Fasing Application<br> | [<ul><li>24 Rules</li></ul><ul><li>9 Models</li></ul>](RM/r_m_ironnet_irondefense_Compromised_Credentials.md) |
