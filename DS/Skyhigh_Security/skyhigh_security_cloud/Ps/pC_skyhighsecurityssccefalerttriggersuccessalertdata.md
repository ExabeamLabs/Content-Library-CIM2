...
```Java
{
Name = skyhighsecurity-ssc-cef-alert-trigger-success-alertdata
  Vendor = Skyhigh Security
  Product = Skyhigh Security Cloud
  TimeFormat = "MMM dd yyyy HH:mm:ss.SSS z"
  Conditions = [  """CEF:0""" , """Alert.""", """activityName =""", """actorIdType=""", """serviceNames=""", """|Skyhigh Security|""" ]
  Fields = [
    ...
    """\|Skyhigh Security\|Skyhigh Security Cloud\|[^\|]+\|({alert_name}[^\|]+)\|""",
    """userAction=({action}[^=]+?)\s\w+=""",
    """incidentId=({alert_id}[^=]+?)\s\w+=""",
    """serviceNames=\[?(|({additional_info}[^=\]]+?))\]?\s+\w+=""",   
    """\sdhost=({dest_host}[\w\.\-]+)""",
    """activityName =\[({activity_details}[^\]]+?)\]"""
  ]
