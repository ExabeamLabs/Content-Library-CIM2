...
|          [Malware](../../../UseCases/uc_malware.md)          |  network-traffic:success (network-connection-successful)<br> ↳[barracuda-waf-str-network-traffic-trafficallow](Ps/pC_barracudawafstrnetworktraffictrafficallow.md)<br> | TA0011 - TA0011<br>    | [<ul><li>3 Rules</li></ul>](RM/r_m_barracuda_barracuda_waf_Malware.md)    |
