...
```Java
{
Name = barracuda-esg-json-dlp-email-deferred
  ParserVersion = "v1.0.0"
  Conditions = [ """"action":"deferred"""", """"delivered":"not_delivered"""", """"hdr_from":"""", """"hdr_to":"""" ]
...
barracuda-dlp-email{
    ...
    Fields = [
      ...
      """"delivered":"({result}[^"]+)""""
      """"email":"({dest_email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({dest_email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))"""
