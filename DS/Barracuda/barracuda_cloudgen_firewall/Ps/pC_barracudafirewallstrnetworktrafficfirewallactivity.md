...
Fields = [
  ...
  """\/box_Firewall_Activity:\s+([^\s]+\s+){3}([^\|]*\|){3}(?:0.0.0.0|({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?)""",
  ...
  """\/box_Firewall_Activity:\s+([^\s]+\s+){3}([^\|]*\|){13}(?:0.0.0.0|({dest_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?)""",
