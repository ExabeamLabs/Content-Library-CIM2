...
```Java
{
Name = f5-dc-json-alert-trigger-success-secevent-violations
  ParserVersion = v1.0.0
  Conditions = [  """"violations":""", """"vh_name":""", """"sec_event_type":""" ]
  Fields = ${F5ParsersTemplates.f5-distributed-cloud-json.Fields}[
    """exa_json_path=$.sec_event_name,exa_field_name=alert_name"""
    """exa_json_path=$.sec_event_name,exa_field_name=alert_subject"""
    """exa_json_path=$.sec_event_type,exa_field_name=alert_type"""
    """exa_json_path=$.violations..attack_type,exa_field_name=alert_type"""
    """exa_json_path=$.violations..name,exa_field_name=alert_name"""
    """exa_json_path=$.violations..matching_info,exa_field_name=additional_info"""
