...
"""No shared ciphers between SSL peers""" 
  ...
  Fields = [
    """\d\d:\d\d:\d\d ({host}[^\s]+)""",
    """peers ({src_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))\.({src_port}\d+):({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))\.({dest_port}\d+)""",
