...
```Java
{
Name = f5-waf-str-network-traffic-success-connectionresponse
  ...
  Fields = [
    ...
    """\d\d:\d\d:\d\d ({host}[\w.-]+)""",
    """Client:({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))\s""",
    """POOL_MEMBER:({dest_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))\s""",
