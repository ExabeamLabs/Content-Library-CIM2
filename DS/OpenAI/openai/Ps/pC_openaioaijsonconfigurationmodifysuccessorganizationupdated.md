...
```Java
{
Name = openai-oai-json-configuration-modify-success-organizationupdated
   ParserVersion = "v1.0.0"
   Conditions = [""""type":"organization.updated"""", """"ja3":""", """"ja4":""", """organization.updated"""]
...
openaievents = {
    ...
    Fields = [
      ...
      """exa_json_path=$.actor.session.user.email,exa_regex=({email_address}[A-Za-z0-9!#$%&'+\/=?^_`~.-]+@({email_domain}[^\]\s"\\,;\|]+\.[^\]\s"\\,;\|]+))""",
