...
```Java
{
Name = openai-oai-json-app-logout-success-logoutsucceeded
   ParserVersion = "v1.0.0"
   Conditions = [""""type":"logout.succeeded"""", """"effective_at":""", """"actor":""" ]
...
openai-json-audit-clp = {
    ...
    Fields = [
      ...
      """exa_json_path=$.actor.type,exa_field_name=credential_type"""
      """exa_json_path=$.actor.session.user.email,exa_field_name=email_address"""
      """exa_json_path=$.actor.session.user.id,exa_field_name=user_id"""
      """exa_json_path=$.actor.session.ip_address,exa_field_name=src_ip"""
      """exa_json_path=$.actor.session.user_agent,exa_field_name=user_agent"""
      """exa_json_path=$.actor..user.email,exa_field_name=email_address"""
      """exa_json_path=$.actor..user.id,exa_field_name=user_id"""
      """exa_json_path=$.actor..ip_address,exa_field_name=src_ip"""
      """exa_json_path=$.project.name,exa_field_name=project_name"""
      """exa_json_path=$.project.id,exa_field_name=project_id"""
