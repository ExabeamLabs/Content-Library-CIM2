...
```Java
{
Name = beyondtrust-prividentity-kv-app-authentication-2006
  ParserVersion = v1.0.0
  Conditions = [ """sEventType=""", """sEventID="EVENT_ID_PASSWORD_REQUESTED"""", """sOriginatingApplicationName ="Privileged Identity"""" ]
