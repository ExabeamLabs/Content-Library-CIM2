...
```Java
{
Name = beyondtrust-prividentity-kv-app-activity-privilegedidentity
  ParserVersion = "v1.0.0"
  Product = BeyondTrust Privileged Identity
  Conditions = [ """sEventType=""", """sEventID="EVENT_ID_WEBAPP_GENERIC_EVENT"""", """sOriginatingApplicationName ="Privileged Identity"""" ]
