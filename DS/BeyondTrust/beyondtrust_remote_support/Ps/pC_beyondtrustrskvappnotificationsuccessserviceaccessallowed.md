...
```Java
{
Name = beyondtrust-rs-kv-app-notification-success-serviceaccessallowed
  Conditions = [ """|BeyondTrust|Remote Support Appliance|""", """|Service Access Allowed|""", """|sessionId=""", """deviceHost=""" ]
  ParserVersion = "v1.0.0"
  Fields = ${BeyondTrustParserTemplates.beyondtrust-remote-support-events.Fields} [
    """\|accessGrantedTo=({target}[^\|]+)\|""",
    """\|accessLevel=({access}[^\|]+)\|""",
    """\|accessService=({access_type}[^\|]+)\|"""
  ]
