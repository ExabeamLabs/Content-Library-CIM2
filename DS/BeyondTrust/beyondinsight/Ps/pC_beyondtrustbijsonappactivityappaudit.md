...
```Java
{
Name = beyondtrust-bi-json-app-activity-appaudit
  Conditions = [ """"EventName":""", """"AgentID":"AppAudit"""", """"EventSeverity":""", """"Category":""" ]
  Fields = ${BeyondTrustParserTemplates.json-beyondtrust-beyondinsight.Fields} [
