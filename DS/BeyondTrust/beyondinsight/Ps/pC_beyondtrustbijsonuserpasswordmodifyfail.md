...
```Java
{
Name = beyondtrust-bi-json-user-password-modify-fail
  Conditions = [ """"EventDesc":"Password Change Cancelled""", """"Category":"Change"""", """"AgentID":"PBPS"""", """"EventSeverity":""" ]
...
json-beyondtrust-beyondinsight = {
  ...
  ExtractionType = json
  TimeFormat = ["MM/dd/yyyy HH:mm:ss a","M/dd/yyyy HH:mm:ss a","epoch","epoch_sec"] 
  Fields = [
