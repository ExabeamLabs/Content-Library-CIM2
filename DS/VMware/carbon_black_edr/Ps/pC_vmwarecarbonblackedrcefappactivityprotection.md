...
```Java
{
Name = vmware-carbonblackedr-cef-app-activity-protection
  Product = Carbon Black EDR
  Conditions = [ """CEF:""", """|Carbon Black|Protection|""" ]
...
cef-carbonblack-events-1 {
  ...
  Fields = [
    ...
    """"destAddress":"({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?"""",
    """"name":"({file_path}(\w:|\\\\)[^"]+)"""",
