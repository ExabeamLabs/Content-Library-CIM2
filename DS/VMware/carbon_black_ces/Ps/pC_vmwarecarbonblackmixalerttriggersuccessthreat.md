...
Name = vmware-carbonblack-mix-alert-trigger-success-threat
  ...
  Fields = [
    ...
    """deviceType"+:\s*"+({os}[^"]+)"""",
    """externalIpAddress"+:\s*"+({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?"""",
    ...
    """exa_json_path=$.deviceInfo.externalIpAddress,exa_regex=^({dest_ip}((([0-9a-fA-F.]{0,4}):{1,2}){1,7}([0-9a-fA-F]){0,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?$""",
