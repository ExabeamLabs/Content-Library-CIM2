...
```Java
{
Name = ermes-ebsp-json-app-login-success-detectedtracebusinessaccountlogin
  Conditions = [ """"event_cat":""", """"business_account_protection"""", """"event_id":""", """"detected_trace_business_account_login"""", """"op":""" ]
  Fields = ${ErmesParsersTemplates.json-ermes-app-activity.Fields}[
    """exa_json_path=$..account_details.device_name,exa_field_name=device_name"""
    """exa_json_path=$..account_details.agent_id,exa_field_name=agent_id"""
    """exa_json_path=$..account_details.host,exa_field_name=host"""
    """exa_json_path=$..account_details.policy_name,exa_field_name=policy_name"""
    """exa_json_path=$..account_details.user_agent,exa_field_name=user_agent"""
    """exa_json_path=$..account_details.timestamp,exa_field_name=time"""
  ]
