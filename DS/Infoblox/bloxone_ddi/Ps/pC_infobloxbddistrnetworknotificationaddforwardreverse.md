...
```Java
{
Name = infoblox-bddi-str-network-notification-addforwardreverse
  ParserVersion = v1.0.0
  Conditions = [ """dhcpd[""", """: Attempt to add forward map""", """and reverse map""", """abandoned because of non-retryable failure:""" ]
