...
```Java
{
Name = github-g-json-app-activity-success-pullrequestcreatereviewrequest
  ParserVersion = "v1.0.0"
  ExtractionType = json
  Conditions = [ """"action":""", """"pull_request.create_review_request"""", """"operation_type":""", """"create"""" ]
  Fields = ${GithubParsersTemplates.json-github-actions.Fields} [
    """exa_json_path=$..pull_request_title,exa_field_name=additional_info""",
