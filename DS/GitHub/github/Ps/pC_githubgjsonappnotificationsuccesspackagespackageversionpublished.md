...
Name = github-g-json-app-notification-success-packagespackageversionpublished
  ...
  ExtractionType = json
  Conditions = [ """"action":""", """"packages.package_version_""", """"operation_type":""" ]
  Fields = ${GithubParsersTemplates.json-github-actions.Fields} [
    """exa_json_path=$..ecosystem,exa_field_name=additional_info""",
    """exa_json_path=$..package,exa_field_name=object"""
    """exa_json_path=$..package,exa_field_name=repository_name"""
  ]    
