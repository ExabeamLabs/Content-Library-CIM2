...
"""\Whost"*:"*\s*({host}[\w\-.]*)"""
"""\Wsrc_addr"*:"*\s*({src_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({src_port}\d+))?"""
"""\Wsrc_port"*:\s*(([A-Fa-f:\d.]+?):)?({src_port}\d+)?\s*("|,|$)"""
"""\Wdst_addr"*:"*\s*({dest_ip}((([0-9a-fA-F.]{1,4}):{1,2}){7}([0-9a-fA-F]){1,4})|(((25[0-5]|(2[0-4]|1\d|[0-9]|)\d)\.?\b){4}))(:({dest_port}\d+))?"""
