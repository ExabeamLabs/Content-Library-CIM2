# Code Changes for microsoft-evazureadppdca-xml-endpoint-activity-fail-30044 (Parser)
...
| edit_regex_field | event_code |  | ['<EventID>({event_code}30044)</EventID>', '<EventID>({event_code}\d+)</EventID>'] |
