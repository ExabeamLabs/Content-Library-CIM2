# Code Changes for microsoft-evazureadppdca-xml-endpoint-activity-success-30035 (Parser)
...
| edit_regex_field | event_code |  | ['<EventID>({event_code}30035)</EventID>', '<EventID>({event_code}\d+)</EventID>'] |
