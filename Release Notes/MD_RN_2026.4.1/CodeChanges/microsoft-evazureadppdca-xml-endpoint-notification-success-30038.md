# Code Changes for microsoft-evazureadppdca-xml-endpoint-notification-success-30038 (Parser)
...
| edit_regex_field | event_code |  | ['<EventID>({event_code}30038)</EventID>', '<EventID>({event_code}\d+)</EventID>'] |
