# Code Changes for microsoft-evazureadppdca-xml-endpoint-activity-success-30043 (Parser)
...
| edit_regex_field | event_code |  | ['<EventID>({event_code}30043)</EventID>', '<EventID>({event_code}\d+)</EventID>'] |
