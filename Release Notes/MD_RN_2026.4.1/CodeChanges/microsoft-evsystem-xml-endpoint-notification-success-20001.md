# Code Changes for microsoft-evsystem-xml-endpoint-notification-success-20001 (Parser)
...
| edit_regex_field | event_code |  | ['<EventID>({event_code}20001)</EventID>', '<EventID>({event_code}\d+)</EventID>'] |
