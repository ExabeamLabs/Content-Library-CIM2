# Code Changes for microsoft-evazureadppdca-xml-service-start-success-20000 (Parser)
...
| edit_regex_field | event_code |  | ['<EventID>({event_code}20000)</EventID>', '<EventID>({event_code}\d+)</EventID>'] |
