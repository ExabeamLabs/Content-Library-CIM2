# Code Changes for microsoft-azuread-xml-user-password-reset-success-30029 (Parser)
...
| edit_regex_field | event_code |  | ['<EventID>({event_code}30029)</EventID>', '<EventID>({event_code}\d+)</EventID>'] |
...
| changed | Conditions |  | ['<EventID>30029</EventID>', 'Microsoft-AzureADPasswordProtection-DCAgent'] |