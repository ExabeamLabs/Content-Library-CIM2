# Code Changes for checkmarx-checkm-json-user-modify-success-userrolesupdated (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account_name', 'dest_email_address', 'dest_email_domain', 'dest_user', 'dest_user_id', 'email_address', 'email_domain', 'group_id', 'group_name', 'removed_role_name', 'src_ip', 'src_port', 'time', 'user'] |
