# Code Changes for epic-siem-cef-app-login-success-login (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account', 'client_id', 'client_name', 'dest_host', 'dest_ip', 'dest_port', 'host', 'operation', 'resource', 'result', 'role', 'src_host', 'user'] |
...
| added_regex_field | client_name |  | ['CLIENTNAME=({client_name}.+?)(?=\s+\w+=|$)'] |
