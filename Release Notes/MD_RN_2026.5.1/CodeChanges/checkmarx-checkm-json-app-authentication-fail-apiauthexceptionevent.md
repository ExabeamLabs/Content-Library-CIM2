...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account_name', 'dest_email_address', 'dest_email_domain', 'dest_user', 'dest_user_id', 'email_address', 'email_domain', 'failure_reason', 'group_id', 'group_name', 'resource_path', 'src_ip', 'src_port', 'time', 'user'] |
