# Code Changes for checkmarx-checkm-json-user-password-modify-success-passwordchanged (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account_name', 'additional_info', 'dest_email_address', 'dest_email_domain', 'dest_user', 'dest_user_id', 'email_address', 'email_domain', 'group_id', 'group_name', 'src_ip', 'src_port', 'time', 'user'] |
