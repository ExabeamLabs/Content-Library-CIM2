# Code Changes for pan-ngfw-csv-app-activity-general (Parser)
...
| edit_regex_field | event_subtype | ['SYSTEM,({event_subtype}[^,]+),', 'SYSTEM,({event_subtype}[^,]+),([^,]*,){3}([^,]+),'] | [',SYSTEM,({event_subtype}[^,]+),', ',SYSTEM,({event_subtype}[^,]+),([^,]*,){3}([^,]+),'] |
