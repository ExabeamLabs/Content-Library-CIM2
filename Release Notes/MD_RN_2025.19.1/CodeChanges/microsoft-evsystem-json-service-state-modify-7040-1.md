# Code Changes for microsoft-evsystem-json-service-state-modify-7040-1 (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['domain', 'event_name', 'login_id', 'service_name', 'service_state', 'user', 'user_sid'] |
...
| added_regex_field | service_name |  | ['exa_regex=The start type of the ({service_name}[^\.="]+) service was changed from[^\.="]+ to ({service_state}[^\.="]+)'] |
| added_regex_field | service_state |  | ['exa_regex=The start type of the ({service_name}[^\.="]+) service was changed from[^\.="]+ to ({service_state}[^\.="]+)'] |