# Code Changes for microsoft-evsystem-json-ssl-start-fail-36874 (Parser)
...
| edit_regex_field | event_name |  | ['exa_json_path=$.Message,exa_regex=(S-[^"]+|({event_name}[^\."]+))', 'exa_regex=({event_name}The \w+ connection request has failed)'] |
