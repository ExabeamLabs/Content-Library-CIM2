# Code Changes for microsoft-mssql-str-database-login-fail-18456 (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['db_name', 'db_user', 'domain', 'event_code', 'event_name', 'host', 'src_ip', 'src_port', 'time', 'user'] |
