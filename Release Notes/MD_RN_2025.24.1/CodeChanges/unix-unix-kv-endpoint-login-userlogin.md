...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account_id', 'additional_info', 'auth_process', 'dest_host', 'event_code', 'event_name', 'host', 'host_ip', 'login_type_text', 'process_id', 'result', 'session_id', 'src_host', 'src_ip', 'src_port', 'time', 'user', 'user_id'] |
