...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account_id', 'account_name', 'additional_info', 'dest_host', 'host', 'host_ip', 'operation', 'operation_id', 'process_dir', 'process_id', 'process_name', 'process_path', 'result', 'session_id', 'src_port', 'time', 'user_uid'] |
...
| edit_regex_field | time |  | ['({time}\d\d\d\d-\d+-\d+T\d\d:\d\d:\d\d\.\d+[-+]\d\d:\d\d)\s+({dest_host}({host}[\w.\-]+))'] |
