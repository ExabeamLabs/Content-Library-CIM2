# Code Changes for postgresql-p-str-database-activity-fatal (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['action', 'additional_info', 'app', 'db_name', 'db_operation', 'operation', 'process_id', 'src_ip', 'src_port', 'time', 'user'] |
