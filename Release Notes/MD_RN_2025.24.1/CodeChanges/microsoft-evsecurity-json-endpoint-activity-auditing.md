...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['domain', 'event_code', 'event_name', 'host', 'login_id', 'new_value', 'old_value', 'process_dir', 'process_id', 'process_name', 'process_path', 'severity', 'src_domain', 'src_user', 'time', 'transaction_id', 'uac_status', 'user', 'user_sid'] |
