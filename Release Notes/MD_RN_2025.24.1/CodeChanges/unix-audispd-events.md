# Code Changes for unix-audispd-events (ParserTemplate)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account_id', 'additional_info', 'dest_host', 'event_name', 'host', 'host_ip', 'process_dir', 'process_id', 'process_name', 'process_path', 'result', 'session_id', 'src_host', 'src_ip', 'src_port', 'time', 'user_id'] |
