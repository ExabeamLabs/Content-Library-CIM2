# Code Changes for crowdstrike-falcon-json-file-read-success-ransomware (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['aid', 'aip', 'app', 'cid', 'event_code', 'file_dir', 'file_ext', 'file_name', 'file_path', 'host', 'object', 'os', 'src_ip', 'src_port', 'time'] |
