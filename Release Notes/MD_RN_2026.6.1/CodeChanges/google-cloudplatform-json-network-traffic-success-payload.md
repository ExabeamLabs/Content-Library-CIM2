...
|-------------|------------|--------|-------|
| COULD_NOT_COMPARE | TimeFormat |  | ["yyyy-MM-dd'T'HH:mm:ss", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSSSSZ"] |
| changed_parsed_fields | N/A |  | ['action', 'bytes_out', 'dest_host', 'dest_ip', 'dest_port', 'direction', 'host', 'packets', 'protocol', 'reporter', 'src_host', 'src_ip', 'src_port', 'time'] |
