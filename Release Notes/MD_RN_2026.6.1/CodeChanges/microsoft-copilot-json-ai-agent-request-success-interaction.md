...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['access', 'action', 'ai_tool_name', 'app', 'app_type', 'blocked', 'conversation_id', 'email_address', 'email_domain', 'event_name', 'full_name', 'message_id', 'model_name', 'resource_id', 'resource_name', 'resource_type', 'src_ip', 'src_port', 'time', 'url', 'user', 'user_id', 'user_type'] |
| edit_regex_field | access |  | ['"Action"\s*:\s*"({action}({access}[^",]+))"'] |
...
| added_regex_field | action |  | ['"Action"\s*:\s*"({action}({access}[^",]+))"'] |
