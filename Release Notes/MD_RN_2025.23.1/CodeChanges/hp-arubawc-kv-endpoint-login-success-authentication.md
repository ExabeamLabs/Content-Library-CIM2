# Code Changes for hp-arubawc-kv-endpoint-login-success-authentication (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['auth_server', 'auth_type', 'dest_ip', 'dest_port', 'domain', 'full_name', 'host', 'session_id', 'time', 'user'] |
