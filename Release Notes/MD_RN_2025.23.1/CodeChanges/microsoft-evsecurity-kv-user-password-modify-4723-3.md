# Code Changes for microsoft-evsecurity-kv-user-password-modify-4723-3 (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['dest_domain', 'dest_user', 'dest_user_sid', 'domain', 'event_code', 'event_id', 'host', 'login_id', 'process_guid', 'result', 'src_domain', 'src_user', 'time', 'user', 'user_sid'] |
