...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['additional_info', 'dest_host', 'event_code', 'event_id', 'event_name', 'file_dir', 'file_ext', 'file_hash', 'file_name', 'file_path', 'host', 'object', 'process_id', 'provider_name', 'request_id', 'result', 'run_level', 'thread_id', 'time', 'user', 'user_sid'] |
