...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['audit_policy_name', 'domain', 'event_code', 'event_id', 'host', 'login_id', 'process_dir', 'process_guid', 'process_id', 'process_name', 'process_path', 'provider_name', 'result', 'run_level', 'src_domain', 'src_user', 'sub_category', 'thread_id', 'time', 'user', 'user_sid'] |
