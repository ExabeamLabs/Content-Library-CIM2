# Code Changes for pingidentity-pi-str-endpoint-login-fail-oauth (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['app', 'auth_method', 'domain', 'email_address', 'email_domain', 'failure_reason', 'host', 'host_ip', 'protocol', 'result', 'src_ip', 'src_port', 'time', 'user'] |
