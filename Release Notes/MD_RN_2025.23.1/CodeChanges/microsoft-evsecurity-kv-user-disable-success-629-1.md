# Code Changes for microsoft-evsecurity-kv-user-disable-success-629-1 (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account_id', 'account_name', 'auth_package', 'auth_process', 'client', 'dest_domain', 'dest_user', 'domain', 'event_code', 'failure_reason', 'host', 'key_length', 'login_id', 'login_type', 'object_server', 'process_command_line', 'process_dir', 'process_guid', 'process_id', 'process_name', 'process_path', 'result_code', 'service_name', 'service_type', 'src_domain', 'src_ip', 'src_port', 'src_user', 'time', 'user', 'user_dn', 'user_sid'] |
