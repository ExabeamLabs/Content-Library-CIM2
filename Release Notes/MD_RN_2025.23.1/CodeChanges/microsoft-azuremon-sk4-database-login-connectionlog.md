# Code Changes for microsoft-azuremon-sk4-database-login-connectionlog (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['action', 'category', 'connection_id', 'db_name', 'event_hub_name', 'event_hub_namespace', 'host', 'operation', 'resource_group', 'resource_id', 'server_name', 'src_ip', 'src_port', 'subscription_id', 'time', 'user'] |
