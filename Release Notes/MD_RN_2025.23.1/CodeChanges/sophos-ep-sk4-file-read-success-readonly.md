# Code Changes for sophos-ep-sk4-file-read-success-readonly (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['additional_info', 'alert_id', 'alert_name', 'alert_severity', 'alert_type', 'domain', 'event_name', 'full_name', 'host', 'malware_url', 'operation', 'os', 'process_name', 'process_path', 'src_host', 'src_ip', 'src_port', 'target', 'time', 'user'] |
