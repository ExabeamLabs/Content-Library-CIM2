...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['dest_domain', 'dest_host', 'dest_user', 'dest_user_sid', 'domain', 'event_code', 'host', 'login_id', 'new_user_name', 'old_user_name', 'privileges', 'run_level', 'src_domain', 'src_user', 'time', 'user', 'user_sid'] |
