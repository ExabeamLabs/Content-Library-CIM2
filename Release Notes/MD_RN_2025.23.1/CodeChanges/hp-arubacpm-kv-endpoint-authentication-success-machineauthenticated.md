# Code Changes for hp-arubacpm-kv-endpoint-authentication-success-machineauthenticated (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['additional_info', 'auth_server', 'dest_ip', 'dest_port', 'domain', 'event_name', 'failure_code', 'host', 'protocol', 'result_code', 'service_name', 'src_domain', 'src_host', 'src_ip', 'src_mac', 'src_port', 'time', 'user', 'user_type'] |
