# Code Changes for microsoft-exchange-kv-app-activity-sendonbehalf (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['additional_info', 'app', 'attachment', 'email_address', 'email_attachments', 'email_domain', 'email_subject', 'host', 'object', 'operation', 'path', 'process_path', 'result', 'src_ip', 'src_port', 'target', 'time', 'user', 'user_sid'] |
