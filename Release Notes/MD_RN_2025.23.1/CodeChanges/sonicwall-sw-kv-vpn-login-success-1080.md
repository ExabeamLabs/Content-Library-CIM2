# Code Changes for sonicwall-sw-kv-vpn-login-success-1080 (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account', 'action', 'bytes', 'bytes_in', 'bytes_out', 'dest_host', 'dest_interface', 'dest_ip', 'dest_port', 'domain', 'email_address', 'host', 'protocol', 'realm', 'session_duration', 'src_host', 'src_interface', 'src_ip', 'src_port', 'time', 'user', 'user_agent'] |
