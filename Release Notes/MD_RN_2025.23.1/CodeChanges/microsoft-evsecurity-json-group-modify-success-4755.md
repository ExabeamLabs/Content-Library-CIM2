...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['domain', 'event_code', 'event_name', 'group_domain', 'group_id', 'group_name', 'host', 'login_id', 'process_id', 'result', 'src_domain', 'src_user', 'thread_id', 'time', 'user', 'user_sid'] |
