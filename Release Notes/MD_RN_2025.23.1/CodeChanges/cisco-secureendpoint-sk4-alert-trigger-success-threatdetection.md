...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['action', 'additional_info', 'alert_name', 'alert_severity', 'alert_type', 'category', 'connector_guid', 'dest_ip', 'dest_port', 'domain', 'email_address', 'file_name', 'file_path', 'hash_md5', 'hash_sha1', 'hash_sha256', 'malware_url', 'process_dir', 'process_name', 'product_name', 'result', 'src_host', 'src_ip', 'src_mac', 'src_port', 'time', 'user'] |
