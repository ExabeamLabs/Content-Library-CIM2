# Code Changes for symantec-endpointprotection-kv-alert-trigger-success-scanningyourcomputer (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['additional_info', 'alert_name', 'alert_type', 'dest_host', 'dest_ip', 'dest_port', 'domain', 'host', 'protocol', 'src_host', 'src_ip', 'time', 'user'] |
| added_regex_field | alert_type |  | ['({alert_type}Somebody is scanning your computer)'] |
