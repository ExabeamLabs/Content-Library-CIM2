# Code Changes for microsoft-evsecurity-json-group-member-remove-success-4757-1 (Parser)
...
| edit_regex_field | member |  | ['<Data Name(\\)?=(\'|")MemberName(\'|")>({member}({user_dn}(?i)(cn)=.+?,({user_ou}OU.+?DC=[\w-]+)))</Data>', '<Data Name(\\)?=(\'|")MemberName(\'|")>({user_dn}(?i)(cn)=({member}.+?),({user_ou}OU.+?DC=[\w-]+))</Data>'] |
| edit_regex_field | user |  | ['<Data Name(\\)?=(\'|")SubjectUserName(\'|")>({src_user}({user}[\w\.\-\!\#\^\~]{1,40}\$?))</Data>'] |
| edit_regex_field | user_dn |  | ['<Data Name(\\)?=(\'|")MemberName(\'|")>({member}({user_dn}(?i)(cn)=.+?,({user_ou}OU.+?DC=[\w-]+)))</Data>', '<Data Name(\\)?=(\'|")MemberName(\'|")>({user_dn}(?i)(cn)=({member}.+?),({user_ou}OU.+?DC=[\w-]+))</Data>'] |
| edit_regex_field | user_ou |  | ['<Data Name(\\)?=(\'|")MemberName(\'|")>({member}({user_dn}(?i)(cn)=.+?,({user_ou}OU.+?DC=[\w-]+)))</Data>', '<Data Name(\\)?=(\'|")MemberName(\'|")>({user_dn}(?i)(cn)=({member}.+?),({user_ou}OU.+?DC=[\w-]+))</Data>'] |
