...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['action', 'additional_info', 'alert_id', 'alert_name', 'alert_severity', 'alert_type', 'category', 'dest_host', 'dest_ip', 'dest_port', 'direction', 'email_address', 'event_name', 'file_dir', 'file_ext', 'file_name', 'file_path', 'hash_md5', 'hash_sha1', 'host', 'malware_url', 'operation', 'parent_process_dir', 'parent_process_id', 'parent_process_name', 'parent_process_path', 'process_command_line', 'process_dir', 'process_id', 'process_integrity', 'process_name', 'process_path', 'protocol', 'src_host', 'src_ip', 'src_port', 'tenant_id', 'time', 'user', 'user_sid'] |
