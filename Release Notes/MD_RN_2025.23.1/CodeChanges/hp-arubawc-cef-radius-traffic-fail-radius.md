# Code Changes for hp-arubawc-cef-radius-traffic-fail-radius (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['additional_info', 'app', 'auth_server', 'dest_ip', 'dest_mac', 'dest_port', 'domain', 'failure_reason', 'host', 'service_name', 'src_ip', 'src_port', 'time', 'user'] |
