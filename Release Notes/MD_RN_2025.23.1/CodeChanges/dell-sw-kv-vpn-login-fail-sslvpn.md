# Code Changes for dell-sw-kv-vpn-login-fail-sslvpn (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account', 'bytes', 'bytes_in', 'bytes_out', 'dest_host', 'dest_interface', 'dest_ip', 'dest_port', 'domain', 'email_address', 'failure_reason', 'host', 'protocol', 'realm', 'session_duration', 'src_host', 'src_interface', 'src_ip', 'src_port', 'time', 'user', 'user_agent'] |
