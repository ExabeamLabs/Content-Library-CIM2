...
| added_regex_field | src_host |  | ['<Computer>({host}({src_host}[\w\-.]+))<\/Computer>', '<\d+>\w+ \d+ \d\d:\d\d:\d\d ({host}({src_host}[\w_\-\.]+))'] |
