# Code Changes for microsoft-evsecurity-kv-user-create-success-4720-2 (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['account_domain', 'account_id', 'account_name', 'dest_domain', 'dest_user', 'domain', 'event_code', 'event_id', 'host', 'login_id', 'process_guid', 'src_domain', 'src_user', 'time', 'user', 'user_sid', 'user_type'] |
