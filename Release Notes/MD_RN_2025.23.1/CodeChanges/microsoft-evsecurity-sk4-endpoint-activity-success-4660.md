# Code Changes for microsoft-evsecurity-sk4-endpoint-activity-success-4660 (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['access', 'access_mask', 'auth_package', 'dest_domain', 'dest_user', 'dest_user_sid', 'domain', 'event_code', 'event_name', 'file_ext', 'file_name', 'file_path', 'handle_id', 'host', 'keywords', 'login_type', 'new_sd', 'object', 'object_class', 'object_server', 'old_sd', 'opcode', 'provider_guid', 'provider_name', 'result', 'src_domain', 'src_host', 'src_ip', 'src_port', 'src_user', 'time', 'user', 'user_sid', 'user_uid'] |
| edit_regex_field | host |  | ["'Computer':\s+'({host}[^']+)", "'Computer':\s+'({src_host}({host}[\w\-\.]+))"] |
