...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['action', 'additional_info', 'category', 'event_hub_name', 'event_hub_namespace', 'host', 'object', 'operation', 'resource', 'resource_group', 'resource_id', 'server_group', 'server_name', 'src_ip', 'src_port', 'subscription_id', 'time', 'user'] |
