...
| edit_regex_field | alert_id |  | [',THREAT,([^,]*,){28}(|({alert_name}[^\(,]+(\(\w+\))?))\s*\(({alert_id}\d+)?', ',THREAT,data,([^,]*,){26}(("*[^"]*")|[^,]*),([^,]*,){4}({alert_id}\d+)(,|$)'] |
| edit_regex_field | alert_name |  | [',THREAT,([^,]*,){28}(|({alert_name}[^\(,]+(\(\w+\))?))\s*\(({alert_id}\d+)?', ',THREAT,({alert_type}({alert_name}[^,]+)),', ',THREAT,data,([^,]*,){26}(("*[^"]*")|[^,]*),({alert_name}[^,]+)(,|$)'] |
| edit_regex_field | alert_type |  | [',THREAT,({alert_type}({alert_name}[^,]+)),', ',THREAT,({alert_type}[^,]+),[^,]*,({time}\d\d\d\d/\d\d/\d\d \d\d:\d\d:\d\d),({src_ip}[\da-fA-F\.:]+),({dest_ip}[\da-fA-F\.:]+)(,|$)'] |
...
| edit_regex_field | dest_ip |  | [',THREAT,([^,]*,){4}({dest_ip}(?!::)[a-fA-F\d.:]+)', ',THREAT,({alert_type}[^,]+),[^,]*,({time}\d\d\d\d/\d\d/\d\d \d\d:\d\d:\d\d),({src_ip}[\da-fA-F\.:]+),({dest_ip}[\da-fA-F\.:]+)(,|$)'] |
...
| edit_regex_field | src_ip |  | [',THREAT,([^,]*,){3}({src_ip}(?!::)[a-fA-F\d.:]+)', ',THREAT,({alert_type}[^,]+),[^,]*,({time}\d\d\d\d/\d\d/\d\d \d\d:\d\d:\d\d),({src_ip}[\da-fA-F\.:]+),({dest_ip}[\da-fA-F\.:]+)(,|$)'] |
...
| edit_regex_field | time |  | [',((?:1969-[^,]+?)|({time}\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\d\.\d+[\+-]\d+:\d+)),', ',THREAT,([^,]*,){2}({time}[^,]+),', ',THREAT,({alert_type}[^,]+),[^,]*,({time}\d\d\d\d/\d\d/\d\d \d\d:\d\d:\d\d),({src_ip}[\da-fA-F\.:]+),({dest_ip}[\da-fA-F\.:]+)(,|$)'] |
