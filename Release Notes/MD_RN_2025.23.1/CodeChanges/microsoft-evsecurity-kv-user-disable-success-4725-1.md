# Code Changes for microsoft-evsecurity-kv-user-disable-success-4725-1 (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['dest_domain', 'dest_user', 'dest_user_sid', 'domain', 'event_code', 'event_id', 'host', 'login_id', 'process_guid', 'src_domain', 'src_user', 'user', 'user_sid'] |
