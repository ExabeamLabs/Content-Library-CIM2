...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['additional_info', 'cls_id', 'domain', 'event_code', 'host', 'login_id', 'opcode', 'process_id', 'result_code', 'run_level', 'src_domain', 'src_ip', 'src_port', 'src_user', 'time', 'user', 'user_sid'] |
