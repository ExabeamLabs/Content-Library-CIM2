# Code Changes for microsoft-windows-kv-file-close-success-327 (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['dest_host', 'event_code', 'file_dir', 'file_ext', 'file_name', 'file_path', 'host', 'operation', 'process_id', 'process_name', 'time'] |
