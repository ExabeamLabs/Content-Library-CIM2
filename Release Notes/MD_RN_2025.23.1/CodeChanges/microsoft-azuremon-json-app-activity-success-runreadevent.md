...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['action', 'category', 'correlation_id', 'event_hub_name', 'event_hub_namespace', 'full_name', 'host', 'object', 'operation', 'resource', 'resource_group', 'resource_id', 'server_group', 'server_name', 'src_ip', 'src_port', 'subscription_id', 'time', 'user'] |
...
| edit_regex_field | object |  | ['"Identity":"\{[^\}]+\\*"UserObjectId\\":\\*"({object}[^"\\]+)"', '"resourceId":"({object}({resource}[^",]+))'] |
