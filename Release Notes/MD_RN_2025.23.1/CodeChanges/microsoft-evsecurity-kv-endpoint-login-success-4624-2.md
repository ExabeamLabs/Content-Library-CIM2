# Code Changes for microsoft-evsecurity-kv-endpoint-login-success-4624-2 (Parser)
...
| edit_regex_field | dest_host |  | ['"dhn":"({dest_host}({host}[\w\-.]+))', 'Computer(Name)?=({dest_host}[\w\-\.]+)([^\s]*\s|;)'] |
