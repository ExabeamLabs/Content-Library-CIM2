...
| edit_regex_field | email_address |  | [',THREAT,([^,]*,){8}\s*(({email_address}[^@,]+@[^\.]+\.[^,]+)|(?:({src_domain}[^\s,\\]+)\\*)?({src_user}({user}[\w\.\-\!\#\^\~]{1,40}\$?))),', 'THREAT,([^,]*?,){8}(({email_address}[^@,]+@[^\.]+\.[^,]+)|(({domain}[\w\.\-]{1,40}?)\\)?({user}[\w\.\-\!\#\^\~]{1,40}\$?)|({full_name}[^,]+)),'] |
...
| edit_regex_field | url |  | [',THREAT,([^,]*,){27}([\\"]*(({url}({malware_url}[^<>".,]+(?:\.[^<>\/\s,]+)?\/[^<>]*?))|({file_name}({malware_file_name}[^<>,]+?)|[^,]*?)[\\\/]*"+,))', 'THREAT,url,([^,]*,){26}("+)?({url}[^\\\/\s:,"]+({uri_path}\/[^\?\s,"]+)?)"?'] |
| edit_regex_field | user |  | [',THREAT,([^,]*,){8}\s*(({email_address}[^@,]+@[^\.]+\.[^,]+)|(?:({src_domain}[^\s,\\]+)\\*)?({src_user}({user}[\w\.\-\!\#\^\~]{1,40}\$?))),', 'THREAT,([^,]*?,){8}(({email_address}[^@,]+@[^\.]+\.[^,]+)|(({domain}[\w\.\-]{1,40}?)\\)?({user}[\w\.\-\!\#\^\~]{1,40}\$?)|({full_name}[^,]+)),'] |
