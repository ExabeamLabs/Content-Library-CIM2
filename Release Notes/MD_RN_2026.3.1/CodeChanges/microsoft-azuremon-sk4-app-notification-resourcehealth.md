...
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['action', 'additional_info', 'app', 'category', 'email_address', 'event_category', 'event_hub_name', 'event_hub_namespace', 'event_name', 'full_name', 'host', 'location', 'object', 'operation', 'provider_name', 'resource', 'resource_group', 'resource_id', 'result', 'result_code', 'result_reason', 'server_name', 'severity', 'src_ip', 'src_port', 'subscription_id', 'time', 'user_agent'] |
