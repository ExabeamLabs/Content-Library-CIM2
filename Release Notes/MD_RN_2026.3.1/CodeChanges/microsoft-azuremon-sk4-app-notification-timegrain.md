# Code Changes for microsoft-azuremon-sk4-app-notification-timegrain (Parser)

| Code Change | Field Name | Before | After |
|-------------|------------|--------|-------|
| changed_parsed_fields | N/A |  | ['action', 'additional_info', 'app', 'category', 'email_address', 'event_hub_name', 'event_hub_namespace', 'full_name', 'host', 'location', 'object', 'operation', 'provider_name', 'resource', 'resource_group', 'resource_id', 'result_code', 'rule_source', 'rule_type', 'server_name', 'severity', 'src_ip', 'src_port', 'subscription_id', 'time', 'user_agent'] |
