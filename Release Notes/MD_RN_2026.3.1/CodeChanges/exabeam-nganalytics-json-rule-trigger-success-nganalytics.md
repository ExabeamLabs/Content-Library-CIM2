# Code Changes for exabeam-nganalytics-json-rule-trigger-success-nganalytics (Parser)
...
| edit_attribute | activity_type |  | ['rule-trigger-test:success', 'rule-trigger:success'] |