...
| Amazon         | [Amazon EKS](DS/Amazon/amazon_eks/ds_amazon_amazon_eks.md)<br>[Amazon RDS](DS/Amazon/amazon_rds/ds_amazon_amazon_rds.md)<br>[Amazon Route 53](DS/Amazon/amazon_route_53/ds_amazon_amazon_route_53.md)<br>[AWS Bastion](DS/Amazon/aws_bastion/ds_amazon_aws_bastion.md)<br>[AWS CloudTrail](DS/Amazon/aws_cloudtrail/ds_amazon_aws_cloudtrail.md)<br>[AWS CloudWatch](DS/Amazon/aws_cloudwatch/ds_amazon_aws_cloudwatch.md)<br>[AWS GuardDuty](DS/Amazon/aws_guardduty/ds_amazon_aws_guardduty.md)<br>[AWS Redshift](DS/Amazon/aws_redshift/ds_amazon_aws_redshift.md)<br>[AWS SSM](DS/Amazon/aws_ssm/ds_amazon_aws_ssm.md)<br>[AWS WAF](DS/Amazon/aws_waf/ds_amazon_aws_waf.md)<br>[VPC Flow Logs](DS/Amazon/vpc_flow_logs/ds_amazon_vpc_flow_logs.md)<br>   |
...
| Aruba Wireless controller            | [Aruba Wireless controller](DS/Aruba_Wireless_controller/aruba_wireless_controller/ds_aruba_wireless_controller_aruba_wireless_controller.md)<br>                |
...
| Barracuda      | [Barracuda Cloudgen Firewall](DS/Barracuda/barracuda_cloudgen_firewall/ds_barracuda_barracuda_cloudgen_firewall.md)<br>[Barracuda Email Security Gateway](DS/Barracuda/barracuda_email_security_gateway/ds_barracuda_barracuda_email_security_gateway.md)<br>[Barracuda WAF](DS/Barracuda/barracuda_waf/ds_barracuda_barracuda_waf.md)<br>[Swift](DS/Barracuda/swift/ds_barracuda_swift.md)<br>                    |
| BeyondTrust    | [Aruba Wireless controller](DS/BeyondTrust/aruba_wireless_controller/ds_beyondtrust_aruba_wireless_controller.md)<br>[BeyondInsight](DS/BeyondTrust/beyondinsight/ds_beyondtrust_beyondinsight.md)<br>[BeyondTrust](DS/BeyondTrust/beyondtrust/ds_beyondtrust_beyondtrust.md)<br>[BeyondTrust Privileged Identity](DS/BeyondTrust/beyondtrust_privileged_identity/ds_beyondtrust_beyondtrust_privileged_identity.md)<br>[BeyondTrust Secure Remote Access](DS/BeyondTrust/beyondtrust_secure_remote_access/ds_beyondtrust_beyondtrust_secure_remote_access.md)<br>[Zeek](DS/BeyondTrust/zeek/ds_beyondtrust_zeek.md)<br> |
...
| Bromium Secure Platform              | [Bromium Secure Platform](DS/Bromium_Secure_Platform/bromium_secure_platform/ds_bromium_secure_platform_bromium_secure_platform.md)<br>    |
...
| CDS            | [CDS](DS/CDS/cds/ds_cds_cds.md)<br>[FTP](DS/CDS/ftp/ds_cds_ftp.md)<br>[Unix](DS/CDS/unix/ds_cds_unix.md)<br>         |
...
| Clearsense     | [Clearsense](DS/Clearsense/clearsense/ds_clearsense_clearsense.md)<br>[SAP](DS/Clearsense/sap/ds_clearsense_sap.md)<br>                    |
...
| Dell           | [Dell](DS/Dell/dell/ds_dell_dell.md)<br>[EMC Isilon](DS/Dell/emc_isilon/ds_dell_emc_isilon.md)<br>[One Identity Manager](DS/Dell/one_identity_manager/ds_dell_one_identity_manager.md)<br>[Sonicwall](DS/Dell/sonicwall/ds_dell_sonicwall.md)<br>        |
...
| DTEX InTERCEPT | [DTEX InTERCEPT](DS/DTEX_InTERCEPT/dtex_intercept/ds_dtex_intercept_dtex_intercept.md)<br>     |
...
| IronPort Web Security                | [IronPort Web Security](DS/IronPort_Web_Security/ironport_web_security/ds_ironport_web_security_ironport_web_security.md)<br>              |
...
| Sailpoint      | [FTP](DS/Sailpoint/ftp/ds_sailpoint_ftp.md)<br>[Honeywell Pro-Watch](DS/Sailpoint/honeywell_pro-watch/ds_sailpoint_honeywell_pro-watch.md)<br>[IdentityNow](DS/Sailpoint/identitynow/ds_sailpoint_identitynow.md)<br>[SecurityIQ](DS/Sailpoint/securityiq/ds_sailpoint_securityiq.md)<br>[Symmetry Access Control](DS/Sailpoint/symmetry_access_control/ds_sailpoint_symmetry_access_control.md)<br>               |
...
| SAP            | [Aruba Wireless controller](DS/SAP/aruba_wireless_controller/ds_sap_aruba_wireless_controller.md)<br>[SAP](DS/SAP/sap/ds_sap_sap.md)<br>[SuccessFactors](DS/SAP/successfactors/ds_sap_successfactors.md)<br> |
...
| Singularity Platform                 | [Singularity Platform](DS/Singularity_Platform/singularity_platform/ds_singularity_platform_singularity_platform.md)<br>                   |
...
| Swift          | [SAP](DS/Swift/sap/ds_swift_sap.md)<br>[Swift](DS/Swift/swift/ds_swift_swift.md)<br>           |
...
| Trend Micro    | [Apex One](DS/Trend_Micro/apex_one/ds_trend_micro_apex_one.md)<br>[Deep Discovery Inspector](DS/Trend_Micro/deep_discovery_inspector/ds_trend_micro_deep_discovery_inspector.md)<br>[Deep Security](DS/Trend_Micro/deep_security/ds_trend_micro_deep_security.md)<br>[OfficeScan](DS/Trend_Micro/officescan/ds_trend_micro_officescan.md)<br>[TippingPoint NGIPS](DS/Trend_Micro/tippingpoint_ngips/ds_trend_micro_tippingpoint_ngips.md)<br>[Trend Micro](DS/Trend_Micro/trend_micro/ds_trend_micro_trend_micro.md)<br>[Trend Micro Cloud App Security](DS/Trend_Micro/trend_micro_cloud_app_security/ds_trend_micro_trend_micro_cloud_app_security.md)<br>[Trend Micro Email Security](DS/Trend_Micro/trend_micro_email_security/ds_trend_micro_trend_micro_email_security.md)<br>[Trend Micro InterScan Web Security](DS/Trend_Micro/trend_micro_interscan_web_security/ds_trend_micro_trend_micro_interscan_web_security.md)<br>[Trend Micro ScanMail](DS/Trend_Micro/trend_micro_scanmail/ds_trend_micro_trend_micro_scanmail.md)<br>[Vision One](DS/Trend_Micro/vision_one/ds_trend_micro_vision_one.md)<br>           |
